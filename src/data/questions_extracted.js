...
// Auto-generated from PDF and Answers files
...
export const questions = [
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "The MOST cost-effective method for hosting a website is to: Create an Amazon S3 bucket and host the website there. Amazon S3 is a highly scalable and cost-effective object storage service. It is a good option for hosting static websites, such as the website in this scenario."
  },
  {
    "id": 33,
    "topic": "Database",
    ...
    "correctAnswer": 2,
    "explanation": "Real-time Data Stream: To share millions of financial transactions with other apps, you need to be able to ingest data in real-time, which is made possible by Amazon Kinesis Data Streams. Data Transformation: You can cleanse and eliminate sensitive data from transactions before storing them in Amazon DynamoDB by utilizing AWS Lambda with Kinesis Data Streams. This takes care of the requirement to handle sensitive data with care. Scalability: DynamoDB and Amazon Kinesis are both extremely scalable technologies that can manage enormous data volumes and adjust to the workload."
  },
  {
    "id": 34,
    "topic": "Security",
    ...
    "correctAnswer": 1,
    "explanation": "AWS Config for Configuration Changes: AWS Config is a service that tracks changes to resource configurations over time. It provides a history of configuration changes to your AWS resources and helps with compliance and auditing by allowing you to assess how resource configurations have changed over time. AWS CloudTrail for API Calls: AWS CloudTrail is designed specifically for recording API calls made to AWS resources. It captures detailed information about who made each API call, the actions taken, and the resources affected. This is essential for auditing and security purposes."
  },
  {
    "id": 35,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Create a customer managed multi-Region KMS key. Create an S3 bucket in each Region. Configure replication between the S3 buckets. Configure the application to use the KMS key with client-side encryption."
  },
  {
    "id": 37,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 3,
    "explanation": "D. Create an Amazon EventBridge (Amazon CloudWatch Events) scheduled event that invokes an AWS Lambda function to query the application's API for the data. B. Use Amazon Simple Email Service (Amazon SES) to format the data and to send the report by email."
  },
  {
    "id": 52,
    "topic": "Migration",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Create a Regional API Gateway endpoint. Associate the API Gateway endpoint with the company's domain name. Import the public certificate associated with the company's domain name into AWS Certificate Manager (ACM) in the same Region. Attach the certificate to the API Gateway endpoint. Configure Route 53 to route traffic to the API Gateway endpoint."
  },
  {
    "id": 57,
    "topic": "Storage",
  ...
  },
  {
    ...
    "options": [
      ...
      "Replace the current security group of the application instances with one that allows inbound SSH access from only the private IP address of the bastion host. E. Replace the current security group of the application instances with one that allows inbound SSH access from only the public IP address of the bastion host."
    ],
    "correctAnswer": 2,
    "explanation": "Replace the current security group of the bastion host with one that only allows inbound access from the external IP range for the company. AND Replace the current security group of the application instances with one that allows inbound SSH access from only the private IP address of the bastion host."
  },
  {
    "id": 74,
    "topic": "Compute",
    ...
    "options": [
      ...
      "Configure the security group for the database tier to allow outbound traffic on ports 443 and 1433 to the security group for the web tier. E. Configure the security group for the database tier to allow inbound traffic on ports 443 and 1433 from the security group for the web tier."
    ],
    "correctAnswer": 0,
    "explanation": "Configure the security group for the web tier to allow inbound traffic on port 443 from 0.0.0.0/0. AND Configure the security group for the database tier to allow inbound traffic on port 1433 from the security group for the web tier."
  },
  {
    "id": 75,
    "topic": "General",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Modify the launchPermission property of the AMI. Share the AMI with the MSP Partner's AWS account only. Modify the key policy to allow the MSP Partner's AWS account to use the key."
  },
  {
    "id": 81,
    "topic": "General",
  ...
  },
  {
    ...
    "options": [
      ...
      "Create an IAM user with an S3 access policy and copy the IAM credentials to the EC2 instance. E. Create a NAT instance and have the EC2 instances use the NAT instance to access the S3 bucket."
    ],
    "correctAnswer": 0,
    "explanation": "Configure a VPC gateway endpoint for Amazon S3 within the VPC. AND Create a bucket policy that limits access to only the application tier running in the VPC."
  },
  {
    "id": 93,
    "topic": "Database",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Increase the visibility timeout in the SQS queue to a value that is greater than the total of the function timeout and the batch window timeout."
  },
  {
    "id": 99,
    "topic": "General",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Create an AWS Key Management Service (AWS KMS) customer managed key. Allow the EC2 role to use the KMS key for encryption operations. Store the encrypted data on Amazon S3."
  },
  {
    "id": 101,
    "topic": "Compute",
  ...
  },
  {
    ...
    "options": [
      ...
      "Manually use an operating system copy command to push the data to the EC2 instance. E. Use AWS DataSync to create a suitable location configuration for the on-premises SFTP server."
    ],
    "correctAnswer": 0,
    "explanation": "Launch the EC2 instance into the same Availability Zone as the EFS file system. AND Install an AWS DataSync agent in the on-premises data center."
  },
  {
    "id": 103,
    "topic": "Storage",
  ...
  },
  {
    ...
    "options": [
      ...
      "Use an AWS Lambda function to automatically add attacker IP addresses to VPC network ACLs. E. Use EC2 Spot Instances in an Auto Scaling group with a target tracking scaling policy that is set to 80% CPU utilization."
    ],
    "correctAnswer": 0,
    "explanation": "Use AWS Shield Advanced to stop the DDoS attack. AND Configure the website to use Amazon CloudFront for both static and dynamic content."
  },
  {
    "id": 105,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Create an AWS Lambda function triggered when the database on Amazon RDS is updated to send the information to an Amazon Simple Queue Service (Amazon SQS) queue for the targets to consume."
  },
  {
    "id": 109,
    "topic": "Storage",
  ...
  },
  {
    ...
    "options": [
      ...
      "Configure S3 Event Notifications to invoke an AWS Lambda function when an image is uploaded. Use the function to resize the image. E. Create an Amazon EventBridge (Amazon CloudWatch Events) rule that invokes an AWS Lambda function on a schedule to resize uploaded images."
    ],
    "correctAnswer": 1,
    "explanation": "Configure the web server to upload the original images to Amazon S3. AND Configure S3 Event Notifications to invoke an AWS Lambda function when an image is uploaded. Use the function to resize the image."
  },
  {
    "id": 111,
    "topic": "Compute",
  ...
  },
  {
    ...
    "options": [
      ...
      "Create the new website and an Amazon S3 bucket. Deploy the website on the S3 bucket with static website hosting enabled. E. Create the new website. Deploy the website by using an Auto Scaling group of Amazon EC2 instances behind an Application Load Balancer."
    ],
    "correctAnswer": 0,
    "explanation": "Configure Amazon CloudFront in front of the website to use HTTPS functionality. AND Create the new website and an Amazon S3 bucket. Deploy the website on the S3 bucket with static website hosting enabled."
  },
  {
    "id": 117,
    "topic": "Analytics",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Implement EC2 Spot Instances."
  },
  {
    "id": 125,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Use an Auto Scaling group to launch the EC2 instances in private subnets. Deploy an RDS Multi-AZ DB instance in private subnets. AND Configure a VPC with two public subnets, two private subnets, and two NAT gateways across two Availability Zones. Deploy an Application Load Balancer in the public subnets."
  },
  {
    "id": 126,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Use Spot Instances in an Amazon Elastic Kubernetes Service (Amazon EKS) managed node group."
  },
  {
    "id": 129,
    "topic": "Database",
    ...
    "correctAnswer": 0,
    "explanation": "Migrate the PostgreSQL database to Amazon Aurora. AND Migrate the web application to be hosted on AWS Fargate with Amazon Elastic Container Service (Amazon ECS)."
  },
  {
    "id": 130,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Create an ongoing replication task. AND Convert the database schema by using the AWS Schema Conversion Tool (AWS SCT)."
  },
  {
    "id": 137,
    "topic": "General",
  ...
  },
  {
    ...
    "options": [
      ...
      "Purchase 1-year All Upfront Reserved instances for the data ingestion layer. E. Purchase a 1-year EC2 instance Savings Plan for the front end and API layer."
    ],
    "correctAnswer": 0,
    "explanation": "Use Spot Instances for the data ingestion layer AND Purchase a 1-year Compute Savings Plan for the front end and API layer."
  },
  {
    "id": 141,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 3,
    "explanation": "Configure an Amazon Simple Queue Service (Amazon SQS) queue as the on-failure destination. Modify the Lambda function to process messages in the queue."
  },
  {
    "id": 149,
    "topic": "General",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Take a manual snapshot of the DB cluster. AND Use AWS Backup to take the backups and to keep the backups for 5 years."
  },
  {
    "id": 158,
    "topic": "Storage",
  ...
  },
  {
    ...
    "options": [
      ...
      "Convert the existing public API to a private API. Update the DNS records to redirect users to the new API endpoint. E. Create an IAM role for each user attempting to access the API. A user will assume the role when making the API call."
    ],
    "correctAnswer": 0,
    "explanation": "Create a usage plan with an API key that is shared with genuine users only. AND Implement an AWS WAF rule to target malicious requests and trigger actions to filter them out."
  },
  {
    "id": 160,
    "topic": "Analytics",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Configure a CloudFront field-level encryption profile."
  },
  {
    "id": 173,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Use AWS Backup to copy EC2 backups and RDS backups to the separate Region."
  },
  {
    "id": 179,
    "topic": "Compute",
    ...
    "correctAnswer": 0,
    "explanation": "Create an IAM role that has read access to the Parameter Store parameter. Allow Decrypt access to an AWS Key Management Service (AWS KMS) key that is used to encrypt the parameter. Assign this IAM role to the EC2 instance."
  },
  {
    "id": 180,
    "topic": "Compute",
    ...
    "options": [
      ...
      "Use Amazon GuardDuty with AWS Shield Standard E. Use AWS Shield Standard with Amazon API Gateway."
    ],
    "correctAnswer": 1,
    "explanation": "Use AWS Shield Advanced with the NLB. AND Use AWS WAF to protect Amazon API Gateway."
  },
  {
    "id": 181,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Configure the Lambda function to run in the VPC with the appropriate security group."
  },
  {
    "id": 185,
    "topic": "Storage",
  ...
  },
  {
    ...
    "options": [
      ...
      "Create an Amazon Elastic Container Service (Amazon ECS) cluster with a Fargate launch type to handle the dynamic application load. E. Create an Amazon Elastic Container Service (Amazon ECS) cluster with an Amazon EC2 launch type to handle the dynamic application load."
    ],
    "correctAnswer": 0,
    "explanation": "Create an Amazon RDS DB instance in Multi-AZ mode. AND Create an Amazon Elastic Container Service (Amazon ECS) cluster with a Fargate launch type to handle the dynamic application load."
  },
  {
    "id": 188,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Store the documents in Amazon S3. Use S3 Object Lock in compliance mode. AND Use server-side encryption with AWS Key Management Service (AWS KMS) customer managed keys. Configure key rotation."
  },
  {
    "id": 190,
    "topic": "General",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Create a read replica. Move reporting queries to the read replica."
  },
  {
    "id": 192,
    "topic": "Database",
    ...
    "correctAnswer": 1,
    "explanation": "Write the document information to an Amazon S3 bucket. Use Amazon Athena to query the data. AND Create an AWS Lambda function that runs when new documents are uploaded. Use Amazon Textract to convert the documents to raw text. Use Amazon Comprehend Medical to detect and extract relevant medical information from the text."
  },
  {
    "id": 193,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Use Amazon ElastiCache for Redis."
  },
  {
    "id": 194,
    "topic": "Compute",
    ...
    "correctAnswer": 0,
    "explanation": "Launch two EC2 instances, each in a different Availability Zone in the same AWS Region. Install the database on both EC2 instances. Configure the EC2 instances as a cluster. Set up database replication."
  },
  {
    "id": 195,
    "topic": "Compute",
    ...
    "correctAnswer": 2,
    "explanation": "Move the EC2 instances into an Auto Scaling group. Configure the order system to send messages to an Amazon Simple Queue Service (Amazon SQS) queue. Configure the EC2 instances to consume messages from the queue."
  },
  {
    "id": 196,
    "topic": "Compute",
    ...
    "correctAnswer": 3,
    "explanation": "Extend the application to add an attribute that has a value of the current timestamp plus 30 days to each new item that is created in the table. Configure DynamoDB to use the attribute as the TTL attribute."
  },
  {
    "id": 197,
    "topic": "Database",
    ...
    "correctAnswer": 1,
    "explanation": "Rehost the application in AWS Elastic Beanstalk with the .NET platform in a Multi-AZ deployment. AND Use AWS Database Migration Service (AWS DMS) to migrate from the Oracle database to Oracle on Amazon RDS in a Multi-AZ deployment."
  },
  {
    "id": 198,
    "topic": "Database",
    ...
    "correctAnswer": 3,
    "explanation": "Use Amazon Elastic Kubernetes Service (Amazon EKS) with AWS Fargate for compute and Amazon DocumentDB (with MongoDB compatibility) for data storage."
  },
  {
    "id": 199,
    "topic": "General",
    ...
    "correctAnswer": 1,
    "explanation": "Use Amazon Transcribe for multiple speaker recognition. Use Amazon Athena for transcript file analysis."
  },
  {
    "id": 200,
    "topic": "Database",
    ...
    "correctAnswer": 3,
    "explanation": "Configure an Amazon Cognito user pool authorizer in API Gateway to allow Amazon Cognito to validate each request."
  },
  {
    "id": 201,
    "topic": "General",
  ...
  },
  {
    ...
    "correctAnswer": 3,
    "explanation": "Use the Amazon Simple Queue Service (Amazon SQS) queue and Lambda to buffer writes to DynamoDB."
  },
  {
    "id": 208,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 3,
    "explanation": "Provision two Amazon Simple Queue Service (Amazon SQS) queues: one for order collection and another for order fulfillment. Configure the EC2 instances to poll their respective queue. Create a metric based on a backlog per instance calculation. Scale the Auto Scaling groups based on this metric."
  },
  {
    "id": 211,
    "topic": "Compute",
  ...
  },
  {
    ...
    "options": [
      ...
      "Update the network ACL to allow inbound/outbound TCP port 443 from source 0.0.0.0/0 and to destination 0.0.0.0/0. E. Update the network ACL to allow inbound TCP port 443 from source 0.0.0.0/0 and outbound TCP port 32768-65535 to destination 0.0.0.0/0."
    ],
    "correctAnswer": 0,
    "explanation": "Create a security group with a rule to allow TCP port 443 from source 0.0.0.0/0. AND Update the network ACL to allow inbound TCP port 443 from source 0.0.0.0/0 and outbound TCP port 32768-65535 to destination 0.0.0.0/0."
  },
  {
    "id": 219,
    "topic": "Compute",
    ...
    "correctAnswer": 3,
    "explanation": "Modify the CloudFormation templates. Replace the EC2 instances with R5 EC2 instances. Deploy the Amazon CloudWatch agent on the EC2 instances to generate custom application latency metrics for future capacity planning."
  },
  {
    "id": 220,
    "topic": "General",
  ...
  },
  {
    ...
    "options": [
      ...
      "Create a VPC endpoint for DynamoDB. E. Embed the access keys in the Java Spring Boot code."
    ],
    "correctAnswer": 0,
    "explanation": "Attach an IAM role that has sufficient privileges to the EKS pod. AND Create a VPC endpoint for DynamoDB."
  },
  {
    "id": 224,
    "topic": "Compute",
    ...
    "options": [
      ...
      "Launch three EC2 instances: two instances in one Availability Zone and one instance in another Availability Zone. E. Launch four EC2 instances: two instances in one Availability Zone and two instances in another Availability Zone."
    ],
    "correctAnswer": 2,
    "explanation": "Create an Amazon Route 53 multivalue answer routing policy. AND Launch four EC2 instances: two instances in one Availability Zone and two instances in another Availability Zone."
  },
  {
    "id": 225,
    "topic": "Analytics",
  ...
  },
  {
    ...
    "options": [
      ...
      "Send the raw data to Amazon Simple Queue Service (Amazon SQS). Use EC2 instances to process the data. E. Use Amazon API Gateway to send the raw data to an Amazon Kinesis data stream. Configure Amazon Kinesis Data Firehose to use the data stream as a source to deliver the data to Amazon S3."
    ],
    "correctAnswer": 0,
    "explanation": "Use AWS Glue to process the raw data in Amazon S3. AND Use Amazon API Gateway to send the raw data to an Amazon Kinesis data stream. Configure Amazon Kinesis Data Firehose to use the data stream as a source to deliver the data to Amazon S3."
  },
  {
    "id": 227,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Publish VPC flow logs to Amazon CloudWatch Logs. Create required metric filters. Create an Amazon CloudWatch metric alarm with a notification action for when the alarm is in the ALARM state."
  },
  {
    "id": 233,
    "topic": "Networking",
    ...
    "options": [
      ...
      "Add the root user to a group containing administrative permissions. E. Apply the required permissions to the root user with an inline policy document."
    ],
    "correctAnswer": 0,
    "explanation": "Ensure the root user uses a strong password. AND Enable multi-factor authentication to the root user."
  },
  {
    "id": 234,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Use the AWS Schema Conversion Tool with AWS Database Migration Service (AWS DMS) using a memory optimized replication instance. Create a full load plus change data capture (CDC) replication task and a table mapping to select all tables."
  },
  {
    "id": 236,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Create a Lambda function URL for the function. Specify AWS_IAM as the authentication type."
  },
  {
    "id": 240,
    "topic": "Networking",
    ...
    "correctAnswer": 1,
    "explanation": "Host the visualization tool in the same AWS Region as the data warehouse. Access it over the internet."
  },
  {
    "id": 241,
    "topic": "Database",
  ...
  },
  {
    ...
    "correctAnswer": 3,
    "explanation": "Reduce the maximum number of EC2 instances in the development environment's Auto Scaling group."
  },
  {
    "id": 246,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Enable binlog replication on the RDS primary node. AND Allow long-running transactions to complete on the source DB instance."
  },
  {
    "id": 248,
    "topic": "Storage",
  ...
  },
  {
    ...
    "options": [
      ...
      "Enable MFA Delete on the bucket. E. Encrypt the bucket using AWS KMS."
    ],
    "correctAnswer": 1,
    "explanation": "Enable versioning on the bucket. AND Enable MFA Delete on the bucket."
  },
  {
    "id": 257,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Use an Amazon CloudWatch metric stream to send the EC2 Auto Scaling status data to Amazon Kinesis Data Firehose. Store the data in Amazon S3."
  },
  {
    "id": 258,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Configure Amazon CloudFront to cache multiple versions of the content. AND Configure a Lambda@Edge function to send specific objects to users based on the User-Agent header."
  },
  {
    "id": 262,
    "topic": "Compute",
    ...
    "correctAnswer": 0,
    "explanation": "Create a peering connection between the VPCs. Add a route table entry for the peering connection in both VPCs. Configure an inbound rule for the ElastiCache cluster's security group to allow inbound connection from the application's security group."
  },
  {
    "id": 263,
    "topic": "Networking",
  ...
  },
  {
    ...
    "options": [
      ...
      "Configure the Auto Scaling group to use the average CPU as the scaling metric. E. Configure the Auto Scaling group to use the average free memory as the scaling metric."
    ],
    "correctAnswer": 0,
    "explanation": "Configure storage Auto Scaling on the RDS for Oracle instance. AND Configure the Auto Scaling group to use the average CPU as the scaling metric."
  },
  {
    "id": 277,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 3,
    "explanation": "Migrate the simulation application to Linux Amazon EC2 instances. Migrate the visualization application to Windows EC2 instances. Configure Amazon FSx for NetApp ONTAP for storage."
  },
  {
    "id": 284,
    "topic": "General",
  ...
  },
  {
    ...
    "options": [
      ...
      "Signed URLs",
      "AWS AppSync",
      "JSON Web Token (JWT) E. AWS Secrets Manager"
    ],
    "correctAnswer": 1,
    "explanation": "Signed URLs"
  },
  {
    "id": 292,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Use Amazon Kinesis Data Streams to stream the data. Use Amazon Kinesis Data Analytics to transform the data. Use Amazon Kinesis Data Firehose to write the data to Amazon S3. Use Amazon Athena to query the transformed data from Amazon S3. AND Use Amazon Managed Streaming for Apache Kafka (Amazon MSK) to stream the data. Use AWS Glue to transform the data and to write the data to Amazon S3. Use Amazon Athena to query the transformed data from Amazon S3."
  },
  {
    "id": 293,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Provision a subnet in each Availability Zone. Configure the Auto Scaling group to distribute the EC2 instances across both Availability Zones. Configure the DB instance for Multi-AZ deployment."
  },
  {
    "id": 299,
    "topic": "Compute",
  ...
  },
  {
    ...
    "options": [
      ...
      "Deploy an Auto Sealing group of Amazon EC2 instances in Local Zones for content delivery and caching. E. Deploy an Auto Scaling group of Amazon EC2 instances to convert the video files to more appropriate formats."
    ],
    "correctAnswer": 0,
    "explanation": "Deploy Amazon CloudFront for content delivery and caching. AND Use Amazon Elastic Transcoder to convert the video files to more appropriate formats."
  },
  {
    "id": 303,
    "topic": "Compute",
  ...
  },
  {
    ...
    "options": [
      ...
      "Review the Trusted Advisor check for Amazon RDS Idle DB Instances. E. Review the Trusted Advisor check for Amazon Redshift Reserved Node Optimization."
    ],
    "correctAnswer": 1,
    "explanation": "Use the Trusted Advisor recommendations from the consolidated billing account to see all RDS instance checks at the same time. AND Review the Trusted Advisor check for Amazon RDS Reserved Instance Optimization."
  },
  {
    "id": 309,
    "topic": "Storage",
  ...
  },
  {
    ...
    "options": [
      ...
      "Enable AWS Config and create rules for auditing and compliance purposes. E. Restore previous resource configurations with an AWS CloudFormation template."
    ],
    "correctAnswer": 0,
    "explanation": "Enable AWS CloudTrail and use it for auditing. AND Enable AWS Config and create rules for auditing and compliance purposes."
  },
  {
    "id": 319,
    "topic": "Compute",
  ...
  },
  {
    ...
    "options": [
      ...
      "Move assets to S3 Standard-Infrequent Access (S3 Standard-IA) after 30 days. E. Move assets to S3 One Zone-Infrequent Access (S3 One Zone-IA) after 30 days."
    ],
    "correctAnswer": 0,
    "explanation": "Move assets to S3 Intelligent-Tiering after 30 days. AND Configure an S3 Lifecycle policy to clean up incomplete multipart uploads."
  },
  {
    "id": 327,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Use AWS Snowball. AWS Snowball is a physical data transport solution that helps customers transfer large amounts of data into and out of AWS. It addresses challenges associated with large-scale data transfers, particularly when network constraints, transfer times, or security concerns make online data transfer less practical."
  },
  {
    "id": 332,
    "topic": "General",
    ...
    "correctAnswer": 1,
    "explanation": "Migrate the files to an Amazon FSx for Windows File Server file system. Integrate the Amazon FSx file system with the on-premises Active Directory. Configure AWS Client VPN. Amazon FSx for Windows File Server is a fully managed file storage service built on Windows Server. It is designed to be integrated with on-premises Active Directory, allowing for a seamless extension of your existing directory and authentication infrastructure to the AWS Cloud."
  },
  {
    "id": 333,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Set up AWS Transfer Family with SFTP for Amazon S3. Configure integrated Active Directory authentication. AWS Transfer Family is a fully managed service that allows you to set up an SFTP (Secure File Transfer Protocol) service for Amazon S3. It enables you to transfer files directly to and from Amazon S3 using the SFTP protocol. By integrating with Active Directory, you can provide users with seamless access to S3 resources using their existing credentials without modifying their applications."
  },
  {
    "id": 335,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Enable Amazon Elastic Block Store (Amazon EBS) fast snapshot restore on a snapshot. Provision an AMI by using the snapshot. Replace the AMI in the Auto Scaling group with the new AMI. Amazon EBS Fast Snapshot Restore allows you to provision Amazon EBS volumes based on snapshots with faster performance. This is particularly useful when creating AMIs from snapshots, as it reduces the time it takes to create EBS volumes from those snapshots, minimizing initialization latency."
  },
  {
    "id": 336,
    "topic": "Compute",
    ...
    "correctAnswer": 0,
    "explanation": "Create a new AWS Key Management Service (AWS KMS) encryption key. Use AWS Secrets Manager to create a new secret that uses the KMS key with the appropriate credentials. Associate the secret with the Aurora DB cluster. Configure a custom rotation period of 14 days. AWS Secrets Manager will automate the process of rotating the database credentials, which will reduce the operational effort required to meet the IT security guidelines."
  },
  {
    "id": 337,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Migrate the database to Amazon Aurora MySQL. Replace the read replicas with Aurora Replicas, and configure Aurora Auto Scaling. Replace the stored procedures with Aurora MySQL native functions. Aurora Replicas in Amazon Aurora MySQL are designed to have minimal replication lag compared to traditional MySQL read replicas. Aurora Auto Scaling allows you to automatically adjust the number of Aurora Replicas based on actual application usage, minimizing replication lag."
  },
  {
    "id": 338,
    "topic": "Database",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Create credentials on the RDS for MySQL database for the application user and store the credentials in AWS Secrets Manager. Configure the application to load the database credentials from Secrets Manager. Set up a credentials rotation schedule for the application user in the RDS for MySQL database using Secrets Manager. This solution secures the custom application with the least amount of programming effort by automatically rotating the credentials at a specified interval."
  },
  {
    "id": 340,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Use AWS WAF in front of the ALB. Associate the appropriate web ACLs with AWS WAF. AWS WAF (Web Application Firewall) is designed to protect web applications from common web exploits, including SQL injection. By using AWS WAF in front of the ALB, you can define rules to block or allow web requests based on conditions that you specify, including protection against SQL injection attempts."
  },
  {
    "id": 341,
    "topic": "Storage",
    ...
    "correctAnswer": 3,
    "explanation": "Use a Lake Formation blueprint to ingest the data from the database to the S3 data lake. Use Lake Formation to enforce column-level access control for the QuickSight users. Use Amazon Athena as the data source in QuickSight."
  },
  {
    "id": 342,
    "topic": "Compute",
    ...
    "correctAnswer": 2,
    "explanation": "Create a predictive scaling policy for the Auto Scaling group. Configure the policy to scale based on forecast. Set the scaling metric to CPU utilization. Set the target value for the metric to 60%. In the policy, set the instances to pre-launch 30 minutes before the jobs run. In general, if you have regular patterns of traffic increases and applications that take a long time to initialize, you should consider using predictive scaling. Predictive scaling can help you scale faster by launching capacity in advance of forecasted load."
  },
  {
    "id": 343,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Use the Amazon SQS Extended Client Library for Java to host messages that are larger than 256 KB in Amazon S3. This library is specifically designed to handle larger messages in Amazon SQS by transparently offloading them to Amazon S3. It allows you to send a reference to the S3 object in the SQS message while keeping the actual payload in S3, requiring minimal changes to the existing code."
  },
  {
    "id": 345,
    "topic": "General",
    ...
    "correctAnswer": 0,
    "explanation": "Use Amazon Cognito for authentication. Use Lambda@Edge for authorization. Use Amazon CloudFront to serve the web application globally. Amazon Cognito is a fully managed service for user identity and access control. Lambda@Edge allows you to run custom code in response to CloudFront events, including authorization. CloudFront is a global content delivery network (CDN) that can serve the web application globally, distributing content from edge locations for low-latency access."
  },
  {
    "id": 346,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Compute Savings Plan. Compute Savings Plans provide significant cost savings over On-Demand pricing in exchange for a commitment to a consistent amount of compute usage (measured in $/hr) for a 1 or 3 year period. They offer flexibility by allowing you to switch between instance families, sizes, and AZs (Availability Zones) while still benefiting from the savings plan pricing."
  },
  {
    "id": 348,
    "topic": "Database",
    ...
    "correctAnswer": 1,
    "explanation": "Use provisioned mode. Specify the read capacity units (RCUs) and write capacity units (WCUs). In provisioned mode, you provision a specific amount of read and write capacity, which allows you to manage costs more effectively based on your expected workload. This approach is suitable when your workload is predictable, as you can provision the capacity to meet your known requirements."
  },
  {
    "id": 349,
    "topic": "Storage",
    ...
    "correctAnswer": 1,
    "explanation": "Create a database snapshot. Add the acquiring company's AWS account to the KMS key policy. Share the snapshot with the acquiring company's AWS account. Sharing encrypted snapshots involves granting permission not only on the snapshot itself but also on the underlying AWS Key Management Service (KMS) key used for encryption. By adding the acquiring company's AWS account to the KMS key policy, you ensure that they have the necessary permissions to decrypt and access the snapshot."
  },
  {
    "id": 350,
    "topic": "Compute",
    ...
    "correctAnswer": 0,
    "explanation": "Modify the DB instance from a Single-AZ DB instance to a Multi-AZ deployment. AND Create a read replica of the DB instance in a different Availability Zone. Point all requests for reports to the read replica. Enabling Multi-AZ deployment provides high availability by replicating the database to a standby instance in another Availability Zone. By creating a read replica in a different Availability Zone, you offload the reporting workload from the primary instance, reducing the impact on transaction processing."
  },
  {
    "id": 351,
    "topic": "General",
    ...
    "correctAnswer": 3,
    "explanation": "Build out the workflow in AWS Step Functions. Use Step Functions to create a state machine. Use the state machine to invoke AWS Lambda functions to process the workflow steps. AWS Step Functions allows you to coordinate the components of distributed applications using visual workflows. State machines in AWS Step Functions enable you to define the workflow of your application by specifying a series of steps. AWS Lambda is a serverless compute service, and it automatically scales with the workload."
  },
  {
    "id": 352,
    "topic": "General",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Enable RDS Proxy on the RDS DB instance. RDS Proxy is a fully managed, highly available database proxy for Amazon RDS that makes applications more scalable, more resilient to database failures, and more secure. It helps manage database connections efficiently, reducing issues related to connection timeouts and errors."
  },
  {
    "id": 355,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Move the data objects to S3 Standard-Infrequent Access (S3 Standard-IA) after 30 days. S3 Standard-Infrequent Access (S3 Standard-IA) is designed for infrequently accessed data but still provides low-latency and high-throughput performance. It maintains the same high availability and durability as S3 Standard, making it suitable for data that is accessed less frequently."
  },
  {
    "id": 357,
    "topic": "Compute",
    ...
    "options": [
      ...
      "Store the server-side code on Amazon FSx for Windows File Server. Mount the FSx for Windows File Server volume on each EC2 instance to share the files. E. Store the server-side code on a General Purpose SSD (gp2) Amazon Elastic Block Store (Amazon EBS) volume. Mount the EBS volume on each EC2 instance to share the files."
    ],
    "correctAnswer": 0,
    "explanation": "Store the static files on Amazon S3. Use Amazon CloudFront to cache objects at the edge. AND Store the server-side code on Amazon FSx for Windows File Server. Mount the FSx for Windows File Server volume on each EC2 instance to share the files. Amazon S3 is a highly scalable and durable object storage service, and it is well-suited for storing static files. Amazon FSx for Windows File Server provides a fully managed Windows file system that is accessible from Windows-based EC2 instances."
  },
  {
    "id": 358,
    "topic": "Storage",
    ...
    "correctAnswer": 2,
    "explanation": "Use a Lambda@Edge function with an external image management library. Associate the Lambda@Edge function with the CloudFront behaviors that serve the images. Lambda@Edge allows you to run code in response to CloudFront events without provisioning or managing servers. A Lambda@Edge function can be used to dynamically resize images based on the request, minimizing operational overhead."
  },
  {
    "id": 359,
    "topic": "Storage",
    ...
    "correctAnswer": 2,
    "explanation": "Use the aws:SecureTransport condition on S3 bucket policies to allow only encrypted connections over HTTPS (TLS). Configure default encryption for each S3 bucket to use server-side encryption with AWS KMS keys (SSE-KMS). Assign the compliance team to manage the KMS keys. This allows the compliance team to manage the KMS keys used for server-side encryption, thereby providing the necessary control over the encryption keys."
  },
  {
    "id": 360,
    "topic": "Networking",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Use Amazon DynamoDB with DynamoDB Accelerator (DAX) for data that is frequently accessed. Export the data to an Amazon S3 bucket by using DynamoDB table export. Run one-time queries on the data in Amazon S3 by using Amazon Athena. DynamoDB is a highly scalable and low-latency NoSQL database, suitable for frequently accessed data. DynamoDB Accelerator (DAX) is a caching layer that provides sub-millisecond read latencies for DynamoDB."
  },
  {
    "id": 362,
    "topic": "General",
    ...
    "correctAnswer": 1,
    "explanation": "Write the messages to an Amazon Kinesis data stream with the payment ID as the partition key. AND Write the messages to an Amazon Simple Queue Service (Amazon SQS) FIFO queue. Set the message group to use the payment ID. Amazon Kinesis data streams can be used with partition keys to ensure that messages with the same partition key are processed in order. SQS FIFO queues ensure that messages are processed in the order they are received."
  },
  {
    "id": 363,
    "topic": "General",
    ...
    "correctAnswer": 1,
    "explanation": "Amazon Simple Notification Service (Amazon SNS) FIFO topics. SNS FIFO can send events or messages concurrently to many subscribers while maintaining the order it receives. SNS fanout pattern is set in standard SNS which is commonly used to fan out events to large number of subscribers."
  },
  {
    "id": 364,
    "topic": "Networking",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Automated backups. Amazon RDS (Relational Database Service) can automatically create backups of your database every day. These backups are like snapshots of your entire database, capturing all the data. You can decide how long you want to keep these backup snapshots, for example, up to 35 days. This allows you to restore the database to its state from 5 minutes before any change within the last 30 days."
  },
  {
    "id": 366,
    "topic": "Compute",
    ...
    "correctAnswer": 3,
    "explanation": "Implement API usage plans and API keys to limit the access of users who do not have a subscription."
  },
  {
    "id": 367,
    "topic": "Networking",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Set an overall password policy for the entire AWS account. Amazon Web Services (AWS) allows you to set an account-wide password policy using AWS Identity and Access Management (IAM). This policy defines the rules and requirements for all IAM users in the AWS account. It's a centralized approach to enforce security measures consistently across all users."
  },
  {
    "id": 369,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Provision a NAT gateway in a public subnet. Modify each private subnet's route table with a default route that points to the NAT gateway. A NAT gateway is a managed service provided by AWS that allows EC2 instances in private subnets to initiate outbound traffic to the internet while preventing unsolicited inbound traffic from reaching those instances. NAT gateways are fully managed, highly available, and require minimal maintenance."
  },
  {
    "id": 371,
    "topic": "Storage",
    ...
    "options": [
      ...
      "Create the EKS cluster. Create an IAM role that has a policy that grants permission to the customer managed key. Associate the role with the EKS cluster. E. Store the customer managed key as a Kubernetes secret in the EKS cluster. Use the customer managed key to encrypt the EBS volumes."
    ],
    "correctAnswer": 2,
    "explanation": "Enable EBS encryption by default in the AWS Region where the EKS cluster will be created. Select the customer managed key as the default key. AND Create the EKS cluster. Create an IAM role that has a policy that grants permission to the customer managed key. Associate the role with the EKS cluster. EBS encryption is set regionally. Default EBS encryption is a regional setting within your AWS account. Enabling it in a specific region ensures that all new EBS volumes created in that region are encrypted by default."
  },
  {
    "id": 372,
    "topic": "Database",
    ...
    "correctAnswer": 3,
    "explanation": "Store the images in Amazon S3 buckets. Store geographic codes and image S3 URLs in a database table. Use Oracle running on an Amazon RDS Multi-AZ DB instance. We cannot use DynamoDB database because it is a NoSQL database and we want a SQL database because Oracle database is SQL DATABASE. That's why the correct answer uses S3 bucket for storing data and Oracle database for SQL on Amazon RDS."
  },
  {
    "id": 373,
    "topic": "Storage",
    ...
    "correctAnswer": 3,
    "explanation": "Use the S3 Standard storage class. Create an S3 Lifecycle policy to transition objects to S3 Standard-Infrequent Access (S3 Standard-IA) after 30 days, and then to S3 Glacier Deep Archive after 1 year. Use S3 Standard for the first 30 days because it's the default storage class for frequently accessed data. After the initial 30 days, transition the data to S3 Standard-IA. After 1 year, transition the data from S3 Standard-IA to S3 Glacier Deep Archive using an S3 Lifecycle policy."
  },
  {
    "id": 374,
    "topic": "Networking",
    ...
    "correctAnswer": 3,
    "explanation": "Set up one AWS Direct Connect connection from the data center to AWS. Create a transit gateway, and attach each VPC to the transit gateway. Establish connectivity between the Direct Connect connection and the transit gateway. Using a single AWS Direct Connect connection from the data center to AWS is more cost-effective than setting up multiple connections. The use of a transit gateway simplifies network connectivity. It acts as a hub, allowing communication between the VPCs and the on-premises data center without requiring separate connections for each VPC."
  },
  {
    "id": 375,
    "topic": "Compute",
    ...
    "correctAnswer": 0,
    "explanation": "Use AWS Step Functions to build the application. Step Functions provide a way to coordinate and orchestrate multiple AWS services, including AWS Lambda functions, in a serverless workflow. They allow you to build applications by connecting various serverless functions and services without managing the underlying infrastructure."
  },
  {
    "id": 376,
    "topic": "Compute",
    ...
    "correctAnswer": 0,
    "explanation": "Create a proxy in RDS Proxy. Configure the users' applications to use the DB instance through RDS Proxy. RDS Proxy is a fully managed, highly available database proxy for Amazon RDS that makes applications more scalable, more resilient to database failures, and more secure. It automatically routes database traffic to the appropriate DB instance, handling connection pooling and failover."
  },
  {
    "id": 377,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Use a Network Load Balancer for traffic distribution and Amazon DynamoDB on-demand for data storage. Think of an NLB like a traffic cop for your game. It helps distribute and manage the incoming traffic from players to your game servers. DynamoDB is a type of database that can store data for your game, such as gamer scores. 'On-demand' means that DynamoDB automatically scales to handle the amount of data and traffic your game is experiencing."
  },
  {
    "id": 379,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 3,
    "explanation": "Create an AWS Lambda function that will start and stop the EC2 instances and DB instances. Configure Amazon EventBridge to invoke the Lambda function on a schedule. AWS Lambda is a serverless compute service that allows you to run code without provisioning or managing servers. EventBridge provides a reliable and scalable way to schedule the execution of Lambda functions at specified intervals, such as starting and stopping instances during business hours."
  },
  {
    "id": 381,
    "topic": "Storage",
    ...
    "correctAnswer": 1,
    "explanation": "Set up a new Amazon Aurora PostgreSQL DB cluster that includes an Aurora Replica. Issue queries to the Aurora Replica to generate the reports. Aurora Replicas are read replicas that can be used to offload read traffic from the primary database instance. By issuing queries to the Aurora Replica, you can generate reports without affecting the performance of the primary database instance."
  },
  {
    "id": 382,
    "topic": "Compute",
    ...
    "correctAnswer": 0,
    "explanation": "Configure a TLS listener. Deploy the server certificate on the NLB. Configuring a TLS listener on the NLB allows you to encrypt data in transit between the users' devices and the NLB. This ensures that the data is secure during transmission."
  },
  {
    "id": 383,
    "topic": "Compute",
  ...
  },
  {
    ...
    "options": [
      ...
      "Create a new IAM user for the deployment engineer and add the IAM user to a group that has an IAM policy that allows AWS CloudFormation actions only. E. Create an IAM role for the deployment engineer to explicitly define the permissions specific to the AWS CloudFormation stack and launch stacks using that IAM role."
    ],
    "correctAnswer": 3,
    "explanation": "Create a new IAM user for the deployment engineer and add the IAM user to a group that has an IAM policy that allows AWS CloudFormation actions only. AND Create an IAM role for the deployment engineer to explicitly define the permissions specific to the AWS CloudFormation stack and launch stacks using that IAM role. This ensures that the IAM user has the necessary permissions for AWS CloudFormation but not unnecessary permissions for other AWS services. IAM roles are more suitable for temporary elevated permissions needed during AWS CloudFormation stack operations. The deployment engineer can assume the role when required, limiting their permissions to only what is needed for those specific actions."
  },
  {
    "id": 388,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Use an Amazon DynamoDB table to store customer session information. AND Deploy an Amazon ElastiCache for Redis cluster to store customer session information. (Choose two - this question has multiple correct answers)"
  },
  {
    "id": 391,
    "topic": "Storage",
    ...
    "correctAnswer": 2,
    "explanation": "Retain the latest Amazon Machine Images (AMIs) of the web and application tiers. Enable automated backups in Amazon RDS and use point-in-time recovery to meet the RPO. Snapshots of EBS volumes would be necessary if you want to back up the entire EC2 instance, including any applications and temporary data stored on the EBS volumes attached to the instances. When you take a snapshot of an EBS volume, it backs up the entire contents of that volume. This ensures that you can restore the entire EC2 instance to a specific point in time more quickly. However, if there is no temporary data stored on the EBS volumes, then snapshots of EBS volumes are not necessary."
  },
  {
    "id": 392,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Configure an Amazon Transcribe transcription job with PII redaction turned on. When an audio file is uploaded to the S3 bucket, invoke an AWS Lambda function to start the transcription job. Store the output in a separate S3 bucket. Amazon Transcribe is a fully managed service provided by Amazon Web Services (AWS) that enables automatic speech recognition (ASR). It allows developers to convert spoken language into written text, making it useful for various applications such as transcription services, voice analytics, and content indexing."
  },
  {
    "id": 394,
    "topic": "Storage",
    "question": "A company is running a multi-tier ecommerce web application in the AWS Cloud. The application runs on Amazon EC2 instances with an Amazon RDS for MySQL Multi-AZ DB instance. Amazon RDS is configured with the latest generation DB instance with 2,000 GB of storage in a General Purpose SSD (gp3) Amazon Elastic Block Store (Amazon EBS) volume. The database performance affects the application during periods of high demand. A database administrator analyzes the logs in Amazon CloudWatch Logs and discovers that the application performance always degrades when the number of read and write IOPS is higher than 20,000. What should a solutions architect do to improve the application performance?",
    "options": [
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Subscribe to AWS Shield Advanced. Add the accelerator as a resource to protect. AWS Shield Advanced is a managed Distributed Denial of Service (DDoS) protection service provided by AWS. By subscribing to AWS Shield Advanced, you gain access to enhanced DDoS protection capabilities, including automatic detection and mitigation of DDoS attacks."
  },
  {
    "id": 397,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Enable Amazon DynamoDB Streams on the table. Use triggers to write to a single Amazon Simple Notification Service (Amazon SNS) topic to which the teams can subscribe. Using a single SNS topic simplifies the notification process. The trigger can publish a message to this topic, and each internal team can subscribe to this topic. This reduces the operational overhead compared to managing multiple SNS topics (Option B)."
  },
  {
    "id": 401,
    "topic": "Database",
    ...
    "correctAnswer": 0,
    "explanation": "Deploy the application servers by using Amazon EC2 instances in an Auto Scaling group across multiple Availability Zones. Use an Amazon RDS DB instance in a Multi-AZ configuration. Auto Scaling Across Multiple Availability Zones: Deploying application servers using EC2 instances in an Auto Scaling group across multiple Availability Zones (AZs) helps avoid a single point of failure. If one AZ experiences an issue, the application can continue to operate in another AZ."
  },
  {
    "id": 402,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Update the Kinesis Data Streams default settings by modifying the data retention period. (Note: Question 402 answer is missing from Answers.txt)"
  },
  {
    "id": 403,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 3,
    "explanation": "Create an Amazon Simple Queue Service (Amazon SQS) queue. Send the requests to the queue. Configure the queue as an event source for Lambda. Introducing Amazon SQS as a queue allows for better decoupling between the S3 events and the document processing. This ensures that the Lambda function is not overwhelmed with spikes in incoming events, leading to missed document processing."
  },
  {
    "id": 405,
    "topic": "Compute",
  ...
  },
  {
    ...
    "options": [
      ...
      "Create a security group for the DB instance. Add a rule to allow traffic from the web servers’ security group on port 3306. E. Create a security group for the DB instance. Add a rule to deny all traffic except traffic from the web servers’ security group on port 3306."
    ],
    "correctAnswer": 2,
    "explanation": "Create a security group for the web servers in the public subnet. Add a rule to allow traffic from 0.0.0.0/0 on port 443. AND Create a security group for the DB instance. Add a rule to allow traffic from the web servers' security group on port 3306. This allows inbound traffic from the internet on port 443 to the web servers. This ensures that the RDS instance is accessible only from the web servers in the public subnet."
  },
  {
    "id": 407,
    "topic": "General",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Create the EBS volumes as encrypted volumes. Attach the EBS volumes to the EC2 instances. By creating the EBS volumes as encrypted volumes, you ensure that all data written to those volumes is automatically encrypted. This provides a straightforward and effective solution for meeting the encryption-at-rest requirement."
  },
  {
    "id": 411,
    "topic": "Database",
    ...
    "correctAnswer": 2,
    "explanation": "MySQL-compatible Amazon Aurora Serverless. Aurora Serverless is a serverless option for MySQL-compatible databases. It automatically adjusts the database capacity based on actual usage, making it suitable for sporadic usage patterns. It is MySQL-compatible, so it won't require significant database modifications."
  },
  {
    "id": 412,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Configure the web instance to send email through Amazon Simple Email Service (Amazon SES). Amazon Simple Email Service (Amazon SES) is a fully managed email sending service. By configuring the web instances to send emails through Amazon SES, the ecommerce company can offload the complexity of email delivery to a reliable and scalable service."
  },
  {
    "id": 414,
    "topic": "General",
    ...
    "correctAnswer": 1,
    "explanation": "Create an Amazon S3 File Gateway. Update the business system to use a new network share from the S3 File Gateway. (Note: Question 414 answer is missing from Answers.txt)"
  },
  {
    "id": 415,
    "topic": "Storage",
  ...
  },
  {
    ...
    "options": [
      ...
      "Create a read replica for the RDS DB instance. E. Configure a Multi-AZ deployment for the RDS DB instance."
    ],
    "correctAnswer": 1,
    "explanation": "Set up an Amazon CloudFront distribution. AND Create a read replica for the RDS DB instance. Amazon CloudFront is a content delivery network (CDN) that can improve the performance of a website by caching static content closer to the users. This reduces latency and improves page load times. Configure CloudFront to distribute static content such as images, stylesheets, and JavaScript files. This will offload the serving of static assets from the web servers, improving overall website performance. Creating a read replica for the Amazon RDS database allows you to offload read traffic from the primary database, improving the overall database performance."
  },
  {
    "id": 417,
    "topic": "Compute",
    ...
    "correctAnswer": 2,
    "explanation": "Purchase a Compute Savings Plan. Optimize the Lambda functions' duration and memory usage, the number of invocations, and the amount of data that is transferred. Connect the Lambda functions to the private subnet that contains the EC2 instances. (Note: Question 417 answer is missing from Answers.txt)"
  },
  {
    "id": 418,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Create an SCP. Attach the SCP to the root organizational unit (OU). Define the SCP to deny the ec2:CreateVolume action whenthe ec2:Encrypted condition equals false. AND In the Organizations management account, specify the Default EBS volume encryption setting."
  },
  {
    "id": 420,
    "topic": "Compute",
    ...
    "correctAnswer": 3,
    "explanation": "Use an Amazon RDS Multi-AZ DB cluster deployment Point the read workload to the reader endpoint. Amazon RDS Multi-AZ DB Cluster Deployment: This provides high availability by automatically replicating data to a standby instance in a different Availability Zone. In case of a failure, Amazon RDS automatically fails over to the standby instance."
  },
  {
    "id": 421,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Role AND Group. (Note: Question 423 is Json format - answer missing from Answers.txt)"
  },
  {
    "id": 424,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Deploy the application by using AWS Elastic Beanstalk. Configure a load-balanced environment and a rolling deployment policy. AWS Elastic Beanstalk: It is a fully managed service that simplifies the deployment and operation of applications, including web applications running Apache Tomcat. Elastic Beanstalk handles the deployment details, capacity provisioning, load balancing, auto-scaling, and application health monitoring, making it easier to deploy and manage your applications."
  },
  {
    "id": 428,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Create an IAM role that includes Lambda as a trusted service. Attach a policy to the role that allows read and write access to the DynamoDB table. Update the configuration of the Lambda function to use the new role as the execution role. IAM Role with Lambda as a Trusted Service: This approach follows the principle of least privilege. You create an IAM role that specifically grants the required permissions to access DynamoDB and makes Lambda a trusted service. This ensures that only Lambda functions associated with this role can assume it."
  },
  {
    "id": 429,
    "topic": "Security",
    ...
    "correctAnswer": 3,
    "explanation": "Group members are allowed the ec2:StopInstances and ec2:TerminateInstances permissions for the us-east-1 Region only when logged in with multi-factor authentication (MFA). Group members are permitted any other Amazon EC2 action within the us-east-1 Region. (Note: Question 429 is Json format - answer missing from Answers.txt)"
  },
  {
    "id": 430,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Use Amazon SageMaker to build and train models. Use Amazon QuickSight to visualize the data. (Note: Question 431 answer is missing from Answers.txt)"
  },
  {
    "id": 432,
    "topic": "Database",
    ...
    "correctAnswer": 2,
    "explanation": "Create a service control policy (SCP) to prevent tag modification except by authorized principals. (Note: Question 432 answer is missing from Answers.txt)"
  },
  {
    "id": 433,
    "topic": "General",
    ...
    "correctAnswer": 0,
    "explanation": "Create an Auto Scaling group and a load balancer in the disaster recovery Region. Configure the DynamoDB table as a global table. Configure DNS failover to point to the new disaster recovery Region's load balancer. (Note: Question 433 answer is missing from Answers.txt)"
  },
  {
    "id": 434,
    "topic": "Compute",
    ...
    "correctAnswer": 0,
    "explanation": "Order an AWS Snowball Edge Storage Optimized device. Use AWS Database Migration Service (AWS DMS) with AWS Schema Conversion Tool (AWS SCT) to migrate the database with replication of ongoing changes. Send the Snowball Edge device to AWS to finish the migration and continue the ongoing replication. (Note: Question 434 answer is missing from Answers.txt)"
  },
  {
    "id": 435,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Import the RDS snapshot directly into Aurora. AND Upload the database dump to Amazon S3. Then import the database dump into Aurora."
  },
  {
    "id": 440,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Update the DB instance to be Multi-AZ, and enable deletion protection. Place the EC2 instances behind an Application Load Balancer, and run them in an EC2 Auto Scaling group across multiple Availability Zones. Multi-AZ RDS Instance: By updating the DB instance to be Multi-AZ, you ensure that there is a standby replica in a different Availability Zone, providing high availability and automatic failover in case of a failure in the primary zone. Deletion Protection: Enabling deletion protection for the DB instance helps prevent accidental deletion, reducing the risk of downtime caused by human error."
  },
  {
    "id": 444,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Add a second set of VPNs to the Management VPC from a second customer gateway device. Adding a second set of VPN connections from the Management VPC to a second customer gateway device provides redundancy and eliminates this single point of failure."
  },
  {
    "id": 448,
    "topic": "Networking",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Create a VPC across two Availability Zones. Refactor the application to host the web tier, application tier, and database tier. Host each tier on its own private subnet with Auto Scaling groups for the web tier and application tier. This choice aligns with best practices by using separate subnets for each tier, allowing for better security and scalability. Auto Scaling groups provide elasticity and resiliency. AND Use Elastic Load Balancers in front of the web tier. Control access by using security groups containing references to each layer's security groups. This option introduces an Elastic Load Balancer (ELB) for the web tier, which enhances scalability and resiliency. Using security groups to control access adds an additional layer of security. AND Use an Amazon RDS database Multi-AZ cluster deployment in private subnets. Allow database access only from application tier security groups. This option leverages Amazon RDS for the database tier, utilizing Multi-AZ for high availability. Placing the RDS database in private subnets and restricting access to the application tier security groups enhances security."
  },
  {
    "id": 450,
    "topic": "Networking",
  ...
  },
  {
    ...
    "correctAnswer": 3,
    "explanation": "Use AWS Backup to create a backup vault that has a vault lock in compliance mode. Create the required backup plan. AWS Backup provides a centralized solution for managing backups across various AWS services, including Amazon EC2. By creating a backup vault with a vault lock in compliance mode, the company ensures that the backup files are retained and cannot be altered for the duration of the retention period. Compliance mode is designed to meet regulatory requirements for data retention."
  },
  {
    "id": 454,
    "topic": "General",
    ...
    "correctAnswer": 2,
    "explanation": "Use Workload Discovery on AWS to generate architecture diagrams of the workloads. AWS has a service called AWS Well-Architected Tool, which includes Workload Discovery. Workload Discovery automatically discovers and visualizes the architecture of your workloads. It provides architecture diagrams, best practice recommendations, and insights into your workloads."
  },
  {
    "id": 455,
    "topic": "Networking",
    ...
    "options": [
      ...
      "Create an IAM role for AWS Budgets to run budget actions with the required permissions. E. Add an alert to notify the company when each account meets its budget threshold. Add a budget action that selects the IAM identity created with the appropriate config rule to prevent provisioning of additional resources. F. Add an alert to notify the company when each account meets its budget threshold. Add a budget action that selects the IAM identity created with the appropriate service control policy (SCP) to prevent provisioning of additional resources."
    ],
    "correctAnswer": 1,
    "explanation": "Use AWS Budgets to create a budget. Set the budget amount under the Billing dashboards of the required AWS accounts. AND Create an IAM role for AWS Budgets to run budget actions with the required permissions. AND Add an alert to notify the company when each account meets its budget threshold. Add a budget action that selects the IAM identity created with the appropriate service control policy (SCP) to prevent provisioning of additional resources."
  },
  {
    "id": 456,
    "topic": "Compute",
    ...
    "correctAnswer": 2,
    "explanation": "Create a backup plan by using AWS Backup. Configure cross-Region backup to the second Region for the EC2 instances. AWS Backup is a centralized backup service that allows you to create backup plans for various AWS resources, including EC2 instances. With AWS Backup, you can configure cross-Region backups, meaning you can replicate backups from one AWS Region to another. This provides a cost-effective and centralized solution for backup."
  },
  {
    "id": 457,
    "topic": "Migration",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "From the Organizations management account billing console, activate a user-defined cost allocation tag named department. Create one cost report in Cost Explorer grouping by tag name, and filter by EC2. While AWS provides AWS-defined tags, the use of a user-defined tag provides flexibility in terms of naming and tagging conventions. Activating the tag at the Organizations management account level ensures that the tag is applied to resources across all member accounts."
  },
  {
    "id": 460,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Write orders to an Amazon Simple Queue Service (Amazon SQS) queue. Use EC2 instances in an Auto Scaling group behind an Application Load Balancer to read from the SQS queue and process orders into the database. Amazon SQS, which is a fully managed message queuing service. Writing orders to an SQS queue allows for decoupling the EC2 instances processing the orders from the application writing the orders. EC2 instances in an Auto Scaling group can then read from the SQS queue, ensuring that the processing scales with demand. Using an Auto Scaling group ensures that you can dynamically adjust the number of EC2 instances based on the workload. This can help handle high traffic efficiently."
  },
  {
    "id": 463,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Convert the existing database instance to a Multi-AZ deployment by modifying the database instance and specifying the Multi-AZ option. By converting the existing RDS instance to a Multi-AZ deployment, you enable high availability with automatic failover. Amazon RDS will automatically replicate the database to a standby instance in a different Availability Zone (AZ). In the event of a failure, Amazon RDS will automatically promote the standby to the primary, minimizing downtime."
  },
  {
    "id": 465,
    "topic": "Compute",
    ...
    "correctAnswer": 2,
    "explanation": "Use Provisioned IOPS SSD (io2) EBS volumes with Amazon Elastic Block Store (Amazon EBS) Multi-Attach. Provisioned IOPS SSD (io2) volumes do indeed support Multi-Attach, allowing you to attach a single volume to multiple Nitro-based instances in the same Availability Zone. This can be suitable for scenarios where multiple instances need simultaneous access to a shared volume with high performance."
  },
  {
    "id": 466,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Create a gateway VPC endpoint for Amazon S3. Associate this endpoint with all route tables in the VPC. Gateway VPC Endpoint: A gateway VPC endpoint enables private connectivity between a VPC and Amazon S3. It allows direct access to Amazon S3 without the need for internet gateways, NAT devices, VPN connections, or AWS Direct Connect."
  },
  {
    "id": 472,
    "topic": "Database",
    ...
    "correctAnswer": 0,
    "explanation": "Configure Amazon DynamoDB Accelerator (DAX) for the new messages table. Update the code to use the DAX endpoint. Amazon DynamoDB Accelerator (DAX) is an in-memory caching service for DynamoDB that helps improve the read performance of DynamoDB tables."
  },
  {
    "id": 473,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Create an IAM policy that grants least privilege permission. Attach the policy to the IAM groups. Creating an IAM policy that grants the least privilege required for the users' tasks is a security best practice. By attaching this policy to IAM groups, you ensure that new users added to these groups inherit the specific permissions defined in the policy."
  },
  {
    "id": 477,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "IAM (Note: Question 477 answer is missing from Answers.txt)"
  },
  {
    "id": 478,
    "topic": "Networking",
    ...
    "correctAnswer": 1,
    "explanation": "Create a new Amazon S3 bucket with S3 Versioning enabled. Use S3 Object Lock with a retention period in accordance with the designated date. Configure the S3 bucket for static website hosting. Set an S3 bucket policy to allow read-only access to the objects. S3 Versioning helps maintain multiple versions of an object over time. With S3 Object Lock, you can enforce retention periods during which the objects cannot be modified or deleted. This aligns with the requirement to prohibit modifications or deletions before a designated future date."
  },
  {
    "id": 479,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "VPC endpoint. A VPC endpoint allows you to privately connect your VPC to supported AWS services without requiring an internet gateway, NAT device, VPN connection, or AWS Direct Connect connection. This ensures that traffic between the EC2 instances and Amazon S3 stays within the AWS network and does not traverse the public internet."
  },
  {
    "id": 481,
    "topic": "Database",
    ...
    "correctAnswer": 1,
    "explanation": "Implement the write-through caching strategy. In a write-through caching strategy, when data is written to the database, it is also written to the cache simultaneously. This ensures that the cache is always up-to-date with the latest data in the database. When a customer adds an item to the database, the write-through strategy ensures that the cache is updated at the same time, maintaining consistency between the cache and the database."
  },
  {
    "id": 482,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Use the s3 sync command in the AWS CLI to move the data directly to an S3 bucket. The s3 sync command in the AWS CLI is a straightforward and efficient way to transfer data from an on-premises location to an S3 bucket. It supports encryption in transit using SSL/TLS, meeting the requirement to encrypt data during transfer."
  },
  {
    "id": 483,
    "topic": "General",
    ...
    "correctAnswer": 2,
    "explanation": "Use Amazon Elastic Container Service (Amazon ECS) on AWS Fargate to run the job. Create a scheduled task based on the container image of the job to run every 10 minutes. AWS Fargate is a serverless compute engine for containers that allows you to run containers without managing the underlying infrastructure. It's well-suited for containerized workloads. Amazon ECS on Fargate supports scheduled tasks, allowing you to run containers at specified intervals. This is a cost-effective solution for jobs that run periodically."
  },
  {
    "id": 484,
    "topic": "Networking",
    ...
    "options": [
      ...
      "Create a new organization in AWS Organizations. Configure the organization's authentication mechanism to use AWS Directory Service directly. E. Set up AWS IAM Identity Center (AWS Single Sign-On) in the organization. Configure IAM Identity Center, and integrate it with the company's corporate directory service."
    ],
    "correctAnswer": 0,
    "explanation": "Create a new organization in AWS Organizations with all features turned on. Create the new AWS accounts in the organization. AND Set up AWS IAM Identity Center (AWS Single Sign-On) in the organization. Configure IAM Identity Center, and integrate it with the company's corporate directory service."
  },
  {
    "id": 485,
    "topic": "General",
    ...
    "correctAnswer": 0,
    "explanation": "Store the video archives in Amazon S3 Glacier and use Expedited retrievals. Amazon S3 Glacier is a low-cost storage service designed for data archiving and long-term backup. It is suitable for rarely accessed data. Expedited retrievals in S3 Glacier allow you to access your archived data within 1-5 minutes, meeting the requirement of having the files available in a maximum of five minutes."
  },
  {
    "id": 486,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Use Amazon S3 to host static content. Use Amazon Elastic Container Service (Amazon ECS) with AWS Fargate for compute power. Use a managed Amazon RDS cluster for the database. Amazon S3 is a highly scalable and cost-effective solution for hosting static content. It eliminates the need for managing web servers for static files. Amazon ECS with AWS Fargate is a serverless container orchestration service. It simplifies deployment and reduces operational overhead by eliminating the need to manage the underlying infrastructure. A managed Amazon RDS cluster provides a fully managed relational database service, reducing the operational burden of database management tasks such as backups, patching, and scaling."
  },
  {
    "id": 487,
    "topic": "Compute",
    ...
    "correctAnswer": 2,
    "explanation": "Amazon Elastic File System (Amazon EFS) with multiple mount targets. Amazon EFS is a fully managed, scalable, and highly available file storage service that can be mounted by multiple instances concurrently. It supports the NFS protocol, making it compatible with Linux instances. EFS provides a file system that can be accessed by multiple EC2 instances in AWS and on-premises through native protocols. It meets the requirement of being mountable by multiple Linux instances."
  },
  {
    "id": 488,
    "topic": "General",
    ...
    "correctAnswer": 2,
    "explanation": "Create a service control policy (SCP) to deny access to the billing information. Attach the SCP to the root organizational unit (OU). Service Control Policies (SCPs) in AWS Organizations allow you to set permission guardrails for member accounts. By creating an SCP that denies access to billing information and attaching it to the root OU, you ensure that this policy applies to all member accounts, including the root user of those accounts."
  },
  {
    "id": 489,
    "topic": "General",
    ...
    "correctAnswer": 2,
    "explanation": "Configure an Amazon SNS dead letter queue that has an Amazon Simple Queue Service (Amazon SQS) target with a retention period of 14 days. Amazon SNS supports dead letter queues (DLQs) to capture messages that fail to be delivered to subscribers. By configuring an SNS DLQ with an SQS target, you can retain messages that are not successfully delivered to the on-premises HTTPS endpoint. Setting the retention period to 14 days allows you to analyze the messages within the specified timeframe."
  },
  {
    "id": 490,
    "topic": "Storage",
    ...
    "correctAnswer": 1,
    "explanation": "Export the data directly from DynamoDB to Amazon S3 with continuous backups. Turn on point-in-time recovery for the table. DynamoDB supports exporting table data directly to Amazon S3. This feature allows you to create continuous backups without affecting the availability of the application or consuming read capacity units (RCUs). Point-in-time recovery (PITR) is a feature in DynamoDB that enables you to restore your table to any point in time within the last 35 days. Turning on PITR ensures that you have continuous backups without impacting the application's performance."
  },
  {
    "id": 491,
    "topic": "General",
    ...
    "correctAnswer": 2,
    "explanation": "Use the AWS Lambda event source mapping. Set Amazon Simple Queue Service (Amazon SQS) FIFO queues as the event source. Use AWS KMS keys (SSE-KMS). Add the kms:Decrypt permission for the Lambda execution role. FIFO (First-In-First-Out) queues ensure that messages are processed in the order they are sent, which is important for credit card data validation to maintain the sequence of requests. AWS KMS keys (SSE-KMS) provide server-side encryption for messages in the SQS queue, ensuring that the credit card data is encrypted at rest."
  },
  {
    "id": 492,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Use AWS Organizations to organize the accounts into organizational units (OUs). Define and attach a service control policy (SCP) to control the usage of EC2 instance types. AWS Organizations allows you to centrally manage and govern multiple AWS accounts. By organizing accounts into OUs, you can apply policies at the OU level. Service Control Policies (SCPs) are a type of policy in AWS Organizations that allows you to set permission guardrails. You can use SCPs to restrict the creation of specific EC2 instance types across multiple accounts."
  },
  {
    "id": 493,
    "topic": "Networking",
    ...
    "options": [
      ...
      "Use Amazon Transcribe to convert the audio recordings in any language into text. E. Use Amazon Translate to translate text in any language to English. F. Use Amazon Comprehend to create the sentiment analysis reports."
    ],
    "correctAnswer": 3,
    "explanation": "Use Amazon Transcribe to convert the audio recordings in any language into text. AND Use Amazon Translate to translate text in any language to English. AND Use Amazon Comprehend to create the sentiment analysis reports."
  },
  {
    "id": 494,
    "topic": "Compute",
    ...
    "correctAnswer": 3,
    "explanation": "The request to terminate the EC2 instance does not originate from the CIDR blocks 192.0.2.0/24 or 203.0.113.0/24. The IAM policy includes a condition that restricts actions based on the source IP address. The condition specifies that the actions are allowed only if the request originates from the CIDR blocks 192.0.2.0/24 or 203.0.113.0/24."
  },
  {
    "id": 495,
    "topic": "Storage",
    ...
    "correctAnswer": 2,
    "explanation": "Configure Amazon Macie to run a data discovery job that uses managed identifiers for the required data types. Amazon Macie is a fully managed data security and data privacy service that uses machine learning and pattern matching to discover and protect sensitive data in AWS. Macie can automatically discover personally identifiable information (PII) and financial information, including passport numbers and credit card numbers, in Amazon S3 buckets."
  },
  {
    "id": 496,
    "topic": "Networking",
    ...
    "options": [
      ...
      "Deploy an AWS Storage Gateway volume gateway to replace the block storage. E. Deploy Amazon Elastic File System (Amazon EFS) volumes and mount them to on-premises servers."
    ],
    "correctAnswer": 1,
    "explanation": "Deploy an AWS Storage Gateway file gateway to replace NFS storage. AND Deploy an AWS Storage Gateway volume gateway to replace the block storage."
  },
  {
    "id": 497,
    "topic": "Storage",
    ...
    "correctAnswer": 2,
    "explanation": "Provision a VPC gateway endpoint. Configure the route table for the private subnet to use the gateway endpoint as the route for all S3 traffic. A VPC gateway endpoint for Amazon S3 allows instances in a VPC to communicate with S3 without going through a NAT gateway or internet gateway. This eliminates data transfer costs associated with using a NAT gateway for S3 traffic."
  },
  {
    "id": 498,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Use S3 Lifecycle to delete expired object versions and retain the two most recent versions. S3 Lifecycle policies allow you to automate the management of object versions. You can configure a lifecycle rule to delete expired object versions while retaining a specific number of recent versions."
  },
  {
    "id": 499,
    "topic": "Networking",
    ...
    "correctAnswer": 3,
    "explanation": "Contact an AWS Direct Connect Partner to order a 200 Mbps hosted connection for an existing AWS account. AWS Direct Connect Partners offer hosted connections, which are connections provided by AWS Direct Connect Partners. Hosted connections are available in various capacities, including 200 Mbps. By ordering a 200 Mbps hosted connection, the company can reduce costs compared to a 1 Gbps connection while still meeting its average connection utilization of less than 10%."
  },
  {
    "id": 500,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Deploy AWS DataSync agents on premises. Schedule DataSync tasks to transfer the data to the FSx for Windows File Server file system. AND Order an AWS Snowcone device. Connect the device to the on-premises network. Launch AWS DataSync agents on the device. Schedule DataSync tasks to transfer the data to the FSx for Windows File Server file system."
  },
  {
    "id": 501,
    "topic": "Storage",
    ...
    "correctAnswer": 2,
    "explanation": "Use Amazon Kinesis Data Firehose to ingest data. Use Amazon Kinesis Data Analytics to analyze the data in real time. Amazon Kinesis Data Firehose is a fully managed service for real-time data streaming. It can automatically ingest, transform, and load streaming data into data lakes, data stores, and analytics services. Kinesis Data Firehose can directly deliver data to Amazon S3, making it suitable for ingesting payment data into the data lake. Amazon Kinesis Data Analytics allows you to process and analyze streaming data in real time using SQL queries or Apache Flink applications."
  },
  {
    "id": 502,
    "topic": "Storage",
    ...
    "correctAnswer": 2,
    "explanation": "Move the website images onto an Amazon Elastic File System (Amazon EFS) file system that is mounted on every EC2 instance. AND Create an Amazon Machine Image (AMI) from the existing EC2 instance. Use the AMI to provision new instances behind an Application Load Balancer as part of an Auto Scaling group. Configure the Auto Scaling group to maintain a minimum of two instances. Configure an Amazon CloudFront distribution for the website."
  },
  {
    "id": 503,
    "topic": "Compute",
    ...
    "correctAnswer": 0,
    "explanation": "Ensure that the customers create an IAM role in their account with read-only EC2 and CloudWatch permissions and a trust policy to the company's account. By having customers create an IAM role with a trust policy to the company's account, the company can assume that role to access the customer's resources. This is a secure and recommended approach for cross-account access."
  },
  {
    "id": 504,
    "topic": "Networking",
    ...
    "correctAnswer": 2,
    "explanation": "Create an AWS Transit Gateway in the networking team's AWS account. Configure static routes from each VPC. AWS Transit Gateway is designed to simplify the connectivity between multiple VPCs. It acts as a central hub that allows you to connect multiple VPCs and on-premises networks. This approach reduces the complexity of managing peering connections individually."
  },
  {
    "id": 505,
    "topic": "Compute",
    ...
    "correctAnswer": 2,
    "explanation": "Create a new launch template for the Auto Scaling group. Set the instances to Spot Instances. Set a policy to scale out based on CPU usage. Spot Instances allow you to bid for unused EC2 capacity at a potentially lower cost than On-Demand pricing. This can result in significant cost savings for batch jobs that are fault-tolerant and can be interrupted or retried. Setting a policy to scale out based on CPU usage ensures that additional Spot Instances are launched when the demand for processing power increases during batch job execution."
  },
  {
    "id": 506,
    "topic": "Storage",
    ...
    "correctAnswer": 2,
    "explanation": "Generate Amazon S3 presigned URLs in the application. Upload files directly from the user's browser into an S3 bucket. Amazon S3 Presigned URLs: This approach allows the client (user's browser) to directly upload files to Amazon S3 using a presigned URL generated by the server. This offloads the file transfer process from the application servers and enables a direct upload to S3 from the client side."
  },
  {
    "id": 507,
    "topic": "Database",
    ...
    "correctAnswer": 0,
    "explanation": "Convert the application to use Amazon DynamoDB. Use a global table for the center reservation table. Use the correct Regional endpoint in each Regional deployment. Using DynamoDB's global tables feature, you can achieve a globally consistent reservation database with low latency on updates, making it suitable for serving a global user base. The automatic replication provided by DynamoDB eliminates the need for manual synchronization between Regions."
  },
  {
    "id": 508,
    "topic": "Storage",
    ...
    "options": [
      ...
      "Create a backup vault by using AWS Backup. Use AWS Backup to create a backup plan for the EC2 instances based on tag values. Define the destination for the copy as us-west-2. Specify the backup schedule to run twice daily. E. Create a backup vault by using AWS Backup. Use AWS Backup to create a backup plan for the EC2 instances based on tag values. Specify the backup schedule to run twice daily. Copy on demand to us-west-2."
    ],
    "correctAnswer": 1,
    "explanation": "Create an Amazon EC2-backed Amazon Machine Image (AMI) lifecycle policy to create a backup based on tags. Schedule the backup to run twice daily. Configure the copy to the us-west-2 Region. AND Create a backup vault by using AWS Backup. Use AWS Backup to create a backup plan for the EC2 instances based on tag values. Define the destination for the copy as us-west-2. Specify the backup schedule to run twice daily."
  },
  {
    "id": 509,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Modify the network ACL for the web tier subnets. Add an inbound deny rule for the IP addresses that are consuming resources. Network ACLs operate at the subnet level and can be used to deny traffic from specific IP addresses. By modifying the network ACL for the web tier subnets and adding an inbound deny rule for the problematic IP addresses, you can block the illegitimate requests before they reach the instances."
  },
  {
    "id": 510,
    "topic": "Database",
    ...
    "correctAnswer": 2,
    "explanation": "Configure a VPC peering connection between the ap-southeast-2 VPC and the eu-west-1 VPUpdate the subnet route tables. Create an inbound rule in the ap-southeast-2 database security group that allows traffic from the eu-west-1 application server IP addresses. VPC peering connections can be established between VPCs in different AWS Regions. In this case, a VPC peering connection is set up between the VPC in ap-southeast-2 and the VPC in eu-west-1."
  },
  {
    "id": 511,
    "topic": "Database",
    ...
    "correctAnswer": 2,
    "explanation": "Configure each development environment with its own Amazon Aurora On-Demand PostgreSQL-Compatible database. Amazon Aurora is designed for high-performance, scalability, and availability. It offers features such as automatic failover, replication, and performance enhancements over traditional PostgreSQL. On-Demand pricing means you pay for the resources you consume, making it a flexible option."
  },
  {
    "id": 512,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Use AWS Config to identify all untagged resources. Tag the identified resources programmatically. Use tags in the backup plan. AWS Config can be used to identify untagged resources, and it can provide a comprehensive view of the resource inventory across your AWS Organization. AWS Backup supports the use of tags in backup plans. By utilizing tags, you can create a backup plan that automatically includes resources based on their tags."
  },
  {
    "id": 513,
    "topic": "General",
    ...
    "correctAnswer": 0,
    "explanation": "Create a static website hosted in Amazon S3 that invokes AWS Lambda functions to resize the images and store the images in an Amazon S3 bucket. Hosting a static website in Amazon S3 is a cost-effective and highly available solution. Amazon S3 provides scalable and durable object storage. A static website in S3 can serve as the front end for user interactions. In this option, Lambda functions can be triggered by events (e.g., new image uploads to an S3 bucket) to perform image resizing. Lambda can efficiently handle sporadic and unpredictable workloads."
  },
  {
    "id": 514,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Create interface VPC endpoints to allow nodes to access the control plane. When the Amazon EKS control plane has private access, nodes need to communicate with the control plane through interface VPC endpoints. Creating interface VPC endpoints ensures that the nodes in private subnets can securely communicate with the EKS control plane without the need for public IP addresses."
  },
  {
    "id": 515,
    "topic": "Database",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Use Amazon API Gateway and AWS Lambda functions with provisioned concurrency. Amazon API Gateway is a fully managed service that makes it easy for developers to create, publish, maintain, monitor, and secure APIs at any scale. AWS Lambda is a serverless computing service that automatically scales based on demand. Provisioned concurrency in AWS Lambda allows you to set a specific number of concurrent executions to ensure that the function is ready to respond quickly to incoming requests."
  },
  {
    "id": 517,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Enable S3 logging in the Systems Manager console. Choose an S3 bucket to send the session data to. While AWS Systems Manager supports logging command output to an S3 bucket, this is primarily for storing the output of commands executed through Systems Manager, not specifically for Session Manager logs. It may not capture all the detailed session logs, including interactive session input/output and other session-specific details."
  },
  {
    "id": 518,
    "topic": "Compute",
    ...
    "correctAnswer": 0,
    "explanation": "Enable storage autoscaling in RDS. Enabling storage autoscaling allows Amazon RDS to automatically adjust the storage capacity of the database without requiring manual intervention. With autoscaling, the storage capacity can increase dynamically based on the actual usage, preventing the need for manual adjustments."
  },
  {
    "id": 519,
    "topic": "General",
    ...
    "correctAnswer": 1,
    "explanation": "Create AWS Service Catalog products for the customers. AWS Service Catalog allows you to create and manage catalogs of IT services that are approved for use on AWS. It enables you to centrally manage and distribute standardized product portfolios."
  },
  {
    "id": 520,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Configure DynamoDB in on-demand mode by using the DynamoDB Standard table class. On-demand capacity mode allows DynamoDB to automatically scale read and write capacity based on actual application traffic. It eliminates the need for manual provisioning of read and write capacity, making it well-suited for unpredictable workloads. The DynamoDB Standard table class provides general-purpose storage with consistent, single-digit millisecond latency. It's suitable for a wide range of applications, including those with unpredictable traffic."
  },
  {
    "id": 521,
    "topic": "Database",
  ...
  },
  {
    ...
    "options": [
      ...
      "Use Amazon API Gateway and connect it to Amazon EKS. E. Use AWS App Mesh to observe network activity."
    ],
    "correctAnswer": 1,
    "explanation": "Use the Kubernetes Metrics Server for Horizontal Pod Autoscaling AND Use the Kubernetes Cluster Autoscaler. Kubernetes supports Horizontal Pod Autoscaling (HPA) based on custom metrics or resource metrics. By using the Kubernetes Metrics Server, you can enable HPA to automatically adjust the number of pods in a deployment based on observed custom metrics (such as application-specific metrics) or resource metrics (such as CPU or memory usage). The Kubernetes Cluster Autoscaler automatically adjusts the size of the cluster by adding or removing nodes based on the resource utilization and pod scheduling requirements. This helps in scaling the cluster itself based on the overall demand."
  },
  {
    "id": 523,
    "topic": "Database",
    ...
    "correctAnswer": 1,
    "explanation": "Amazon CloudFront with Lambda@Edge functions. Amazon CloudFront is a content delivery network (CDN) service that can distribute content globally with low latency. Lambda@Edge allows you to run custom code in response to CloudFront events, such as viewer requests, origin requests, and more. By using Lambda@Edge functions, you can customize and augment the behavior of CloudFront."
  },
  {
    "id": 524,
    "topic": "Security",
    ...
    "correctAnswer": 2,
    "explanation": "Search CloudTrail logs with Amazon Athena queries to identify the errors. Amazon Athena allows you to query data directly from S3 using standard SQL queries. CloudTrail logs can be stored in Amazon S3, and Athena makes it easy to analyze the logs using SQL queries."
  },
  {
    "id": 525,
    "topic": "General",
    ...
    "correctAnswer": 0,
    "explanation": "Access usage cost-related data by using the AWS Cost Explorer API with pagination. AWS Cost Explorer is a tool provided by Amazon Web Services (AWS) that allows users to visualize, understand, and manage their AWS costs and usage."
  },
  {
    "id": 526,
    "topic": "Compute",
    ...
    "correctAnswer": 3,
    "explanation": "Set up an Amazon RDS proxy for the database. Update the application to use the proxy endpoint. Amazon RDS Proxy is a fully managed, highly available database proxy for Amazon RDS (Relational Database Service). It provides connection pooling, read/write splitting, and automatic failover, helping to improve the availability and scalability of database workloads."
  },
  {
    "id": 527,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Question 528 is missing from the answer file."
  },
  {
    "id": 529,
    "topic": "Database",
    ...
    "correctAnswer": 1,
    "explanation": "Migrate the databases to Amazon RDS Configure encryption at rest. Amazon RDS (Relational Database Service) is a fully managed database service that simplifies database management tasks, such as hardware provisioning, patching, and backups. Amazon RDS supports encryption at rest, which means data stored in the database is automatically encrypted. This provides an additional layer of security for sensitive data. Amazon RDS is a managed service, meaning AWS takes care of operational aspects such as hardware maintenance, software patching, and backups. This reduces operational overhead for the company."
  },
  {
    "id": 530,
    "topic": "Networking",
    ...
    "correctAnswer": 2,
    "explanation": "Add AWS Global Accelerator in front of the NLBs. Configure a Global Accelerator endpoint to use the correct listener ports. AWS Global Accelerator is a service that uses anycast IP addresses to route traffic over the AWS global network to optimal endpoints based on health, geography, and routing policies."
  },
  {
    "id": 531,
    "topic": "Compute",
    ...
    "correctAnswer": 0,
    "explanation": "Create a function URL for the Lambda function. Provide the Lambda function URL to the third party for the webhook. AWS Lambda supports API Gateway integration, which allows you to create an HTTP endpoint (URL) for your Lambda function. Directly exposing the Lambda function through a URL eliminates the need for additional services, such as load balancers or message queues, for simple webhook integration. This approach is straightforward and easy to implement. It provides a direct URL that the third party can use to invoke the Lambda function when the webhook is triggered."
  },
  {
    "id": 532,
    "topic": "Networking",
    ...
    "options": [
      ...
      "Request a wildcard certificate that matches the custom domain name in AWS Certificate Manager (ACM) in the same Region. E. Create multiple API endpoints for each customer in API Gateway. F. Create a custom domain name in API Gateway for the REST API. Import the certificate from AWS Certificate Manager (ACM)."
    ],
    "correctAnswer": 0,
    "explanation": "Register the required domain in a registrar. Create a wildcard custom domain name in a Route 53 hosted zone and record in the zone that points to the API Gateway endpoint AND Request a wildcard certificate that matches the custom domain name in AWS Certificate Manager (ACM) in the same Region AND Create a custom domain name in API Gateway for the REST API. Import the certificate from AWS Certificate Manager (ACM). Registering the domain in a registrar and creating a wildcard custom domain name in Route 53 allows you to manage the DNS records efficiently. The DNS records can point to the API Gateway endpoint. ACM provides a simple way to request and manage SSL/TLS certificates. Requesting a wildcard certificate for the custom domain ensures that it covers all subdomains, allowing for individual and secure URLs. API Gateway allows you to create a custom domain name and associate it with your REST API. By importing a wildcard certificate from AWS Certificate Manager (ACM), you can secure the custom domain."
  },
  {
    "id": 533,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Create a new AWS Key Management Service (AWS KMS) key. Enable Amazon EKS KMS secrets encryption on the Amazon EKS cluster. This option is the most appropriate for encrypting secrets stored in the Kubernetes etcd key-value store within Amazon EKS. Amazon EKS KMS secrets encryption allows you to encrypt secrets in etcd using an AWS Key Management Service (KMS) key. This enhances security by ensuring that the secrets are encrypted at rest."
  },
  {
    "id": 536,
    "topic": "Database",
    ...
    "correctAnswer": 2,
    "explanation": "Change the setup from a Single-AZ to a Multi-AZ instance deployment. Provide two additional read replicas for the data scientists. Changing to a Multi-AZ instance deployment and providing two additional read replicas for the data scientists is a good solution. Multi-AZ provides high availability, and read replicas can be used to offload read-only queries from the production database, allowing data scientists to run their complex queries without impacting the production environment."
  },
  {
    "id": 537,
    "topic": "Compute",
    ...
    "correctAnswer": 0,
    "explanation": "Migrate the MySQL database to Amazon RDS for MySQL with a Multi-AZ DB cluster deployment. Use Amazon ElastiCache for Redis with high availability to store session data and to cache reads. Migrate the web server to an Auto Scaling group that is in three Availability Zones. Migrating the MySQL database to Amazon RDS for MySQL with a Multi-AZ DB cluster deployment provides high availability by replicating the database across multiple Availability Zones. Using Amazon ElastiCache for Redis with high availability ensures that session data and reads are cached effectively, improving performance."
  },
  {
    "id": 538,
    "topic": "Networking",
    ...
    "correctAnswer": 0,
    "explanation": "Add geographic restrictions to the content in CloudFront by using an allow list. Set up a custom error message. CloudFront allows you to set up geographic restrictions by creating an allow list. This allows you to specify the countries from which viewers are allowed to access your content. Viewers from countries not in the allow list will be restricted from accessing the content."
  },
  {
    "id": 539,
    "topic": "High Availability",
    ...
    "correctAnswer": 0,
    "explanation": "Question 539 answer not fully provided in answer file."
  },
  {
    "id": 540,
    "topic": "Database",
    ...
    "correctAnswer": 3,
    "explanation": "Use Amazon RDS deployed in a Multi-AZ instance deployment to create an Amazon Aurora database. Direct the reporting functions to the reader instances. Deploying Amazon RDS in a Multi-AZ instance deployment ensures high availability by replicating the primary database instance in a different Availability Zone (AZ). This provides automatic failover in case of a hardware failure or maintenance event."
  },
  {
    "id": 541,
    "topic": "Storage",
    ...
    "options": [
      ...
      "Create an Amazon Cognito identity pool to authenticate users. E. Use AWS Amplify to serve the frontend web content with HTML, CSS, and JS. Use an integrated Amazon CloudFront configuration. F. Use Amazon S3 static web hosting with PHP, CSS, and JS. Use Amazon CloudFront to serve the frontend web content."
    ],
    "correctAnswer": 0,
    "explanation": "Create an AWS Lambda function to retrieve user information from Amazon DynamoDB. Create an Amazon API Gateway endpoint to accept RESTful APIs. Send the API calls to the Lambda function AND Create an Amazon Cognito user pool to authenticate users AND Use AWS Amplify to serve the frontend web content with HTML, CSS, and JS. Use an integrated Amazon CloudFront configuration. AWS Lambda is a serverless computing service, and its pay-per-use pricing model can be cost-effective for sporadic and unpredictable workloads. DynamoDB is a NoSQL database that can scale with demand. Amazon Cognito provides a scalable and secure user directory for your web application. It allows you to manage user identities and authentication in a cost-effective manner. User pools can be used to handle user registration, authentication, and account recovery. AWS Amplify simplifies the development of scalable and secure cloud-powered web and mobile apps. CloudFront is a content delivery network (CDN) that can efficiently distribute your web content globally, improving performance."
  },
  {
    "id": 542,
    "topic": "Storage",
    ...
    "correctAnswer": 1,
    "explanation": "Generate and provide CloudFront signed URLs to premium customers. This solution involves generating signed URLs for the content, which allows access only to those who have the appropriate permissions. Signed URLs can be time-limited, and you can define custom policies specifying who can access the content and for how long."
  },
  {
    "id": 543,
    "topic": "Compute",
    ...
    "options": [
      ...
      "Create an organization in AWS Organizations in a new payer account. Invite the other AWS accounts to join the organization from the management account. E. Create an organization in AWS Organizations in the existing AWS account with the existing EC2 instances and Savings Plan. Invite the other AWS accounts to join the organization from the management account."
    ],
    "correctAnswer": 0,
    "explanation": "Question 543 answer not provided in answer file."
  },
  {
    "id": 544,
    "topic": "Networking",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Set up a Route 53 active-passive failover configuration. Direct traffic to a static error page that is hosted in an Amazon S3 bucket when Route 53 health checks determine that the ALB endpoint is unhealthy. An active-passive failover configuration in Route 53 involves designating one endpoint (primary, in this case, the ALB) as active and another endpoint (S3 bucket hosting a static error page) as passive. Route 53 health checks can be configured to monitor the health of the ALB endpoint. If the health checks determine that the ALB endpoint is unhealthy (i.e., the primary website is unavailable), Route 53 automatically directs traffic to the passive endpoint (S3 bucket with the static error page)."
  },
  {
    "id": 546,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Use Amazon Kinesis Data Firehose to deliver streaming data to Amazon S3. Amazon Kinesis Data Firehose is a fully managed service for ingesting, transforming, and delivering streaming data to various destinations, including Amazon S3. Kinesis Data Firehose can scale automatically based on the volume of incoming data, and it simplifies the process of delivering data to S3 without the need for manual intervention."
  },
  {
    "id": 548,
    "topic": "Security",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Use S3 Standard. Use an S3 Lifecycle rule to transition the reports to S3 Glacier after 7 days. After the initial period, using an S3 Lifecycle rule to transition the reports to the S3 Glacier storage class is a cost-effective approach. Glacier is designed for long-term archival storage with lower storage costs compared to S3 Standard."
  },
  {
    "id": 552,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Use the memory optimized instance family for both the application and the database. Memory optimized instances are designed to provide a high memory-to-CPU ratio, which aligns well with workloads that have significant memory requirements, such as SAP applications with backend databases."
  },
  {
    "id": 555,
    "topic": "Compute",
    ...
    "correctAnswer": 0,
    "explanation": "Implement an interface VPC endpoint for Amazon SQS. Configure the endpoint to use the private subnets. Add to the endpoint a security group that has an inbound access rule that allows traffic from the EC2 instances that are in the private subnets. Interface VPC endpoints are used for services that are accessed over the Internet, and in this case, it's Amazon SQS. By implementing an interface VPC endpoint for SQS, you can ensure that the traffic stays within the Amazon network."
  },
  {
    "id": 556,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Create an IAM role that has the required permissions to read and write from the DynamoDB tables. Add the role to the EC2 instance profile, and associate the instance profile with the application instances. This is the correct choice because it leverages IAM roles and instance profiles for EC2 instances. By creating an IAM role with the necessary permissions to access DynamoDB and associating it with the EC2 instance profile, you can securely grant permissions to the EC2 instances without exposing API credentials in the CloudFormation template."
  },
  {
    "id": 557,
    "topic": "Storage",
    ...
    "correctAnswer": 1,
    "explanation": "Use Amazon EMR to process the S3 data. Use Amazon EMR with the Amazon Redshift data to enrich the S3 data. Amazon EMR is a cloud-based big data platform that uses Apache Hadoop and other open-source frameworks to process and analyze large datasets. EMR supports parallel data processing, making it a good fit for the requirement. Additionally, using EMR with the Amazon Redshift data allows for efficient enrichment of the S3 data."
  },
  {
    "id": 558,
    "topic": "Networking",
    ...
    "correctAnswer": 2,
    "explanation": "Set up a VPC peering connection between the VPCs. Update the route tables of each VPC to use the VPC peering connection for inter-VPC communication. VPC peering allows communication between VPCs within the same AWS account. It is a cost-effective solution, especially when the VPCs are located in the same region. In this case, both VPCs are in the us-west-2 region."
  },
  {
    "id": 559,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Provision the AWS accounts by using AWS Control Tower. Use account drift notifications to identify the changes to the OU hierarchy. AWS Control Tower is a service that helps you set up and govern a secure, multi-account AWS environment based on AWS best practices. It provides a centralized way to manage and govern multiple AWS accounts. Account drift notifications in AWS Control Tower can help you identify changes to the organizational unit (OU) hierarchy. This feature notifies you when there are changes to the structure of your AWS accounts, making it easier to track and manage modifications."
  },
  {
    "id": 561,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Set up a DynamoDB Accelerator (DAX) cluster. Route all read requests through DAX. DynamoDB Accelerator (DAX) is a fully managed, highly available, in-memory cache for DynamoDB. It is specifically designed to improve the read performance of DynamoDB tables by caching frequently accessed data. DAX is tightly integrated with DynamoDB and requires minimal changes to the application code."
  },
  {
    "id": 562,
    "topic": "Compute",
    ...
    "options": [
      ...
      "Create an elastic network interface for the endpoint in each of the subnets of the VPC. E. Create a security group entry in the endpoint's security group to provide access."
    ],
    "correctAnswer": 0,
    "explanation": "Create a route table entry for the endpoint AND Create a gateway endpoint for DynamoDB. A gateway endpoint is a type of VPC endpoint that allows you to privately connect your VPC to supported AWS services, including DynamoDB, without requiring an internet gateway, NAT device, VPN connection, or AWS Direct Connect connection. By creating a gateway endpoint for DynamoDB, you ensure that API calls from EC2 instances to DynamoDB stay within the AWS network and do not traverse the internet. After creating the gateway endpoint, you need to update the route table associated with the subnets where your EC2 instances are located. This route table entry directs traffic destined for DynamoDB to the gateway endpoint."
  },
  {
    "id": 563,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Use Amazon EKS Connector to register and connect all Kubernetes clusters. Amazon EKS Connector is a feature that allows you to connect and register external Kubernetes clusters (including on-premises clusters) with Amazon EKS. This enables you to view and manage both EKS clusters and external Kubernetes clusters from a central location using the Amazon EKS console."
  },
  {
    "id": 564,
    "topic": "Storage",
    ...
    "correctAnswer": 1,
    "explanation": "Store sensitive data in Amazon RDS for MySQL. Use AWS Key Management Service (AWS KMS) client-side encryption to encrypt the data. Client-side encryption means that the data is encrypted before it is sent to the database. This ensures that even database administrators do not have access to the unencrypted data. AWS KMS can be used to manage the encryption keys securely."
  },
  {
    "id": 565,
    "topic": "Database",
    ...
    "correctAnswer": 2,
    "explanation": "Use AWS Database Migration Service (AWS DMS) to migrate the database to Amazon Aurora. Turn on Aurora Auto Scaling. Amazon Aurora is a MySQL-compatible relational database engine that is designed for high performance and availability. It is compatible with MySQL, making it suitable for migrating a MySQL database. Aurora Auto Scaling allows the database to automatically adjust its capacity based on the actual workload. This is beneficial for handling periods of increased demand without manual intervention."
  },
  {
    "id": 566,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Create an Amazon Elastic File System (Amazon EFS) file system. Mount the EFS file system from each EC2 instance. Amazon EFS is a fully managed, scalable, and elastic file storage service that can be mounted on multiple EC2 instances concurrently. It supports the NFS protocol, making it suitable for applications that require a shared file system. EFS is designed to provide shared access to files across multiple EC2 instances, making it a good fit for scenarios where applications need to read and write rapidly and concurrently to shared storage."
  },
  {
    "id": 567,
    "topic": "Database",
    ...
    "correctAnswer": 0,
    "explanation": "Use Amazon API Gateway with AWS Lambda functions to receive the data from the sensors, process the data, and store the data in an Amazon DynamoDB table. Amazon API Gateway is a fully managed service that makes it easy to create, publish, and manage APIs. It can handle HTTP requests from sensors and trigger AWS Lambda functions. AWS Lambda is a serverless compute service that allows you to run code without provisioning or managing servers. Lambda functions can process the incoming data from sensors. Amazon DynamoDB is a fully managed NoSQL database service that provides fast and predictable performance. It's suitable for storing the processed data."
  },
  {
    "id": 568,
    "topic": "Networking",
    ...
    "correctAnswer": 0,
    "explanation": "Amazon S3 with Amazon CloudFront. Amazon S3 is a scalable object storage service that can store petabytes of data. It is well-suited for storing large files such as engineering drawings. Amazon CloudFront is a content delivery network (CDN) service that caches content at edge locations worldwide. By using CloudFront in front of S3, you can reduce the time it takes for users to access the engineering drawings by serving them from the nearest edge location."
  },
  {
    "id": 569,
    "topic": "General",
    ...
    "correctAnswer": 0,
    "explanation": "Check for metrics in Amazon CloudWatch in the namespace for AWS/Events. Amazon CloudWatch is a monitoring and observability service that collects and tracks metrics, logs, and events. EventBridge integrates with CloudWatch, and you can check for metrics related to EventBridge rules in the AWS/Events namespace. Metrics such as Invocations, FailedInvocations, and TriggeredRules can help you determine whether the rule conditions are being met and if the rule's target is being invoked."
  },
  {
    "id": 570,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Create an Auto Scaling group that has a scheduled action. By creating an Auto Scaling group with a scheduled action, you can configure the group to automatically adjust the desired capacity based on a specified schedule. In this case, you can set up a scheduled action to increase the desired capacity to six instances every Friday evening."
  },
  {
    "id": 571,
    "topic": "General",
    ...
    "correctAnswer": 0,
    "explanation": "Use a local machine to create a certificate that is signed by the third-party CImport the certificate into AWS Certificate Manager (ACM). Create an HTTP API in Amazon API Gateway with a custom domain. Configure the custom domain to use the certificate."
  },
  {
    "id": 572,
    "topic": "Compute",
    ...
    "correctAnswer": 2,
    "explanation": "Provision an Amazon Aurora Serverless v2 database with a minimum capacity of 1 Aurora capacity unit (ACU). Aurora Serverless is designed for applications with variable or unpredictable workloads. With Aurora Serverless v2, you can set the minimum capacity to 1 Aurora capacity unit (ACU), and it will automatically scale based on the actual workload."
  },
  {
    "id": 573,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Migrate the existing RDS for MySQL database to an Aurora Serverless v2 MySQL database cluster. Aurora Serverless allows the database to automatically start up, shut down, and scale capacity based on actual usage. With Aurora Serverless v2, you can set a minimum and maximum capacity for the cluster. This is suitable for intermittent workloads, such as the application that is only operated for 2 hours at the end of each week."
  },
  {
    "id": 575,
    "topic": "Compute",
    ...
    "correctAnswer": 2,
    "explanation": "Create an Amazon RDS database with Multi-AZ DB cluster deployment. Amazon RDS with Multi-AZ (Availability Zone) DB cluster deployment provides high availability by automatically replicating the primary database to a standby instance in a different Availability Zone. This helps ensure database availability in the event of a failure in the primary Availability Zone."
  },
  {
    "id": 576,
    "topic": "Compute",
    ...
    "correctAnswer": 3,
    "explanation": "Edge-optimized endpoint. Edge-optimized endpoints use the global CloudFront network to distribute API traffic across multiple edge locations. This reduces latency for users by serving API requests from the edge locations closest to the users. It leverages the AWS Global Accelerator and CloudFront to automatically route requests to the nearest AWS endpoint."
  },
  {
    "id": 577,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Set the Auto Scaling group's minimum capacity to two. Deploy one On-Demand Instance in one Availability Zone and one On-Demand Instance in a second Availability Zone. Note: Answer not fully provided in the answer file."
  },
  {
    "id": 582,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Set up a geolocation routing policy. Send the traffic that is near us-west-1 to the on-premises data center. Send the traffic that is near eu-central-1 to eu-central-1. Geolocation routing directs traffic based on the geographic location of the user. This option would send users near us-west-1 to the on-premises data center and users near eu-central-1 to eu-central-1. While this approach considers geographic location, it might not always result in the lowest latency."
  },
  {
    "id": 583,
    "topic": "Migration",
  ...
  },
  {
    ...
    "correctAnswer": 3,
    "explanation": "Copy automatic snapshots to another Region every 24 hours. RDS automatically takes snapshots of your database instances. These snapshots capture the entire DB instance, including the data and the DB instance's metadata."
  },
  {
    "id": 589,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Use Amazon ElastiCache for Redis to store the session state. Update the application to use ElastiCache for Redis to store the session state. ElastiCache for Redis is an in-memory data store service that is well-suited for storing session data. It provides high availability and durability. Using Redis allows the application to offload the session state from individual EC2 instances to a centralized and highly available Redis cluster."
  },
  {
    "id": 590,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Use the AWS Load Balancer Controller to provision an Application Load Balancer. This is a Kubernetes-native controller that allows you to define and manage Application Load Balancers and Network Load Balancers to route traffic to services in your Amazon EKS cluster. ALBs are designed for routing HTTP/HTTPS traffic and provide more advanced routing features compared to Network Load Balancers."
  },
  {
    "id": 592,
    "topic": "General",
    ...
    "correctAnswer": 3,
    "explanation": "Use Amazon S3 to store the images. Use Amazon CloudFront to distribute the images with geographic restrictions. Provide a signed URL for each customer to access the data in CloudFront. By using CloudFront, you can cache and serve the images from edge locations around the world, improving access speed for global customers. Geographic Restrictions in CloudFront: CloudFront allows you to set up geographic restrictions to deny access to users from specific countries."
  },
  {
    "id": 593,
    "topic": "Database",
    ...
    "correctAnswer": 0,
    "explanation": "Use Multi-AZ Redis replication groups with shards that contain multiple nodes. Multi-AZ (Availability Zone) replication groups provide high availability at the node level. In a Multi-AZ setup, your data is replicated asynchronously to a standby replica in a different Availability Zone. Using shards with multiple nodes within each Availability Zone further enhances availability and provides scalability."
  },
  {
    "id": 594,
    "topic": "Compute",
    ...
    "correctAnswer": 2,
    "explanation": "Launch the EC2 On-Demand Instances with hibernation turned on. Configure EC2 Auto Scaling warm pools during the next testing phase. When you launch EC2 On-Demand Instances with hibernation turned on, the instances can be hibernated and resumed rather than terminated and launched."
  },
  {
    "id": 595,
    "topic": "Compute",
    ...
    "correctAnswer": 2,
    "explanation": "Use dynamic scaling to change the size of the Auto Scaling group. Dynamic Scaling: With dynamic scaling, the Auto Scaling group automatically adjusts its capacity based on real-time demand. It scales out during traffic spikes and scales in during periods of lower demand. This ensures that your application can handle sudden increases in traffic without manual intervention."
  },
  {
    "id": 596,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Set up a scheduled scaling to increase Lambda provisioned concurrency before employees begin to use the application each day. Lambda Provisioned Concurrency: Provisioned concurrency is the number of simultaneous executions that your function can handle. By setting up a scheduled scaling to increase Lambda provisioned concurrency before employees begin using the application, you are proactively ensuring that there are enough resources available to handle the expected load."
  },
  {
    "id": 598,
    "topic": "Networking",
  ...
  },
  {
    ...
    "options": [
      ...
      "Availability of the Outposts infrastructure including the power supplies, servers, and networking equipment within the Outposts racks E. Physical maintenance of Outposts components F. Providing extra capacity for Amazon ECS clusters to mitigate server failures and maintenance events"
    ],
    "correctAnswer": 0,
    "explanation": "Note: Answer not provided in the answer file."
  },
  {
    "id": 600,
    "topic": "Networking",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Use AWS Backup to set up a backup plan for the entire group of EC2 instances. Use the AWS Backup API or the AWS CLI to speed up the restore process for multiple EC2 instances. AWS Backup: AWS Backup is a fully managed backup service that centralizes and automates the backup of data across AWS services. Backup Plan: You can set up a backup plan in AWS Backup to create and manage backups of the entire group of EC2 instances. AWS Backup provides a streamlined process for restoring data. You can use the AWS Backup console, API, or AWS CLI to initiate the restore process for multiple EC2 instances."
  },
  {
    "id": 603,
    "topic": "Storage",
    ...
    "correctAnswer": 1,
    "explanation": "Use the AWS Step Functions Map state in Distributed mode to process the data in parallel. The Map state in AWS Step Functions is designed for parallel processing. In Distributed mode, it efficiently processes items in parallel, providing a scalable solution. This allows you to process thousands of items concurrently, achieving high throughput."
  },
  {
    "id": 604,
    "topic": "Storage",
    ...
    "correctAnswer": 3,
    "explanation": "Order multiple AWS Snowball devices. Copy the data to the devices. Send the devices to AWS to copy the data to Amazon S3. With only a 500 Mbps uplink bandwidth shared among other on-premises applications, transferring 10 PB of data over the internet would be impractical and time-consuming. AWS Snowball provides a physical device that can be shipped to the company to facilitate faster initial data transfer."
  },
  {
    "id": 605,
    "topic": "General",
    ...
    "correctAnswer": 3,
    "explanation": "Deploy an AWS Storage Gateway volume gateway that is configured with cached volumes. A volume gateway with cached volumes is a good fit when you want to keep frequently accessed data on-premises for low-latency access while still having a copy in the AWS Cloud. Cached volumes store the entire dataset in Amazon S3 while retaining the most frequently accessed data locally."
  },
  {
    "id": 606,
    "topic": "Storage",
    ...
    "correctAnswer": 1,
    "explanation": "Store all the objects in S3 Standard with an S3 Lifecycle rule to transition the objects to S3 Standard-Infrequent Access (S3 Standard-IA) after 30 days. Storing objects in S3 Standard ensures low-latency access and high durability. After 30 days, transitioning objects to S3 Standard-IA allows you to take advantage of a lower storage cost for objects that are less frequently accessed."
  },
  {
    "id": 607,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Create data filters to implement row-level security and cell-level security. AWS Lake Formation allows you to create data filters that can be used for row-level security and cell-level security."
  },
  {
    "id": 610,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 3,
    "explanation": "Configure a VPC endpoint. Update the S3 bucket policy to allow access from the VPC endpoint. Update the application to use the new VPC endpoint. VPC Endpoint for S3: A VPC endpoint allows you to privately connect your VPC to supported AWS services, including Amazon S3, without traversing the public internet. This ensures secure and direct access to S3 from within your VPC."
  },
  {
    "id": 613,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Enable secrets encryption in the EKS cluster by using AWS Key Management Service (AWS KMS). Amazon EKS provides built-in support for encrypting Kubernetes secrets using AWS Key Management Service (AWS KMS). You can enable this feature at the EKS cluster level."
  },
  {
    "id": 614,
    "topic": "Compute",
    ...
    "correctAnswer": 3,
    "explanation": "Deploy an Application Load Balancer with a target group that contains the application servers' Auto Scaling group. Configure the security group to allow only the web servers to access the application servers. An ALB is a load balancer service provided by AWS that allows you to distribute incoming application traffic across multiple targets, such as EC2 instances. In this scenario, the ALB is deployed in front of the application servers. The ALB is configured with a target group that includes the application servers' Auto Scaling group instances. The target group defines where the ALB directs traffic."
  },
  {
    "id": 615,
    "topic": "Compute",
    ...
    "correctAnswer": 3,
    "explanation": "Configure Amazon CloudWatch Container Insights in the existing EKS cluster. View the metrics and logs in the CloudWatch console. CloudWatch Container Insights is specifically designed for monitoring containerized applications on Amazon EKS and ECS. It provides visibility into the performance of containers, clusters, and microservices."
  },
  {
    "id": 616,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Create a service control policy (SCP) that prohibits changes to CloudTrail, and attach it the developer accounts. SCPs are used in AWS Organizations to set fine-grained permissions and restrictions on AWS accounts within the organization. By creating an SCP that explicitly prohibits changes to CloudTrail settings, you can enforce this restriction across all developer accounts."
  },
  {
    "id": 620,
    "topic": "General",
    ...
    "correctAnswer": 2,
    "explanation": "Provisioned IOPS SSD Amazon Elastic Block Store (Amazon EBS) volume. Provisioned IOPS (Input/Output Operations Per Second) SSD volumes are designed to deliver predictable, consistent, and low-latency performance for critical applications. These volumes allow you to specify the amount of IOPS you need, providing a consistent level of performance regardless of the volume size."
  },
  {
    "id": 621,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Create a second S3 bucket in us-east-1. Use S3 Cross-Region Replication to copy photos from the existing S3 bucket to the second S3 bucket. S3 Cross-Region Replication (CRR) is designed specifically for replicating objects across different AWS regions. It is a fully managed feature that automatically replicates objects from the source bucket to the destination bucket in a different region. This requires minimal operational effort as it is a built-in S3 feature for cross-region replication, and you don't have to manually trigger actions or configure additional services."
  },
  {
    "id": 622,
    "topic": "Database",
    ...
    "options": [
      ...
      "Deploy the static content into an Amazon S3 bucket. Provision an Amazon CloudFront distribution with the S3 bucket as the origin. E. Deploy the web servers for static content across a fleet of Amazon EC2 instances in Auto Scaling groups. Configure the instances to periodically refresh the content from an Amazon Elastic File System (Amazon EFS) volume."
    ],
    "correctAnswer": 2,
    "explanation": "Deploy Amazon DynamoDB as the database solution. Ensure that DynamoDB auto scaling is enabled AND Deploy the static content into an Amazon S3 bucket. Provision an Amazon CloudFront distribution with the S3 bucket as the origin. DynamoDB auto scaling allows the database to automatically adjust its read and write capacity based on the application's traffic, making it well-suited for varying workloads. Amazon S3 is a highly scalable and durable object storage service, and using CloudFront, a content delivery network (CDN), helps distribute static content globally, reducing latency and providing scalability."
  },
  {
    "id": 623,
    "topic": "General",
  ...
  },
  {
    ...
    "correctAnswer": 3,
    "explanation": "Configure Security Assertion Markup Language (SAML) 2 0-based federation. Create roles with the appropriate policies attached Map the roles to the Active Directory groups. Using SAML 2.0-based federation, which allows you to integrate AWS with your existing Active Directory infrastructure. This approach enables single sign-on (SSO) for users, meaning they can use their existing corporate credentials to access both on-premises and AWS resources without maintaining separate identities."
  },
  {
    "id": 625,
    "topic": "Storage",
    ...
    "correctAnswer": 2,
    "explanation": "Configure Amazon Route 53 with a geolocation policy. Geolocation routing in Amazon Route 53 allows you to route traffic based on the geographic location of the user. You can create different records for your website content and associate them with specific geographic locations. This way, users from different regions will be directed to the appropriate servers or load balancers hosting the content that adheres to the distribution rights for that region."
  },
  {
    "id": 626,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 0,
    "explanation": "Create 200 new hosted zones in the Amazon Route 53 console Import zone files. Amazon Route 53 is a highly available and scalable domain name system (DNS) web service provided by AWS. By creating 200 new hosted zones in the Amazon Route 53 console and importing the existing zone files, you can take advantage of the fully managed and highly available nature of Route 53 without the need to manage servers."
  },
  {
    "id": 628,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Use an Amazon Elastic Container Service (Amazon ECS) Fargate task triggered by an Amazon EventBridge scheduled event. ECS Fargate is a serverless container service, and it abstracts away the underlying infrastructure. With Fargate, you don't need to manage or provision EC2 instances directly. You can run containers without worrying about the infrastructure, and AWS takes care of scaling and resource allocation."
  },
  {
    "id": 631,
    "topic": "Database",
    ...
    "correctAnswer": 1,
    "explanation": "Use Amazon Neptune to store the information. Use Neptune Streams to process changes in the database. Amazon Neptune is a fully managed graph database service that is designed for storing and querying highly connected data. It supports the property graph and RDF graph models, making it suitable for scenarios where relationships between data entities need to be analyzed. Neptune Streams: Neptune Streams is a feature of Amazon Neptune that allows you to capture changes (inserts, updates, deletes) made to the graph database in a streaming fashion. This streaming capability enables you to react to changes in near real-time and trigger additional processing based on those changes."
  },
  {
    "id": 632,
    "topic": "Compute",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Create a read replica from the source DB instance. Serve read traffic from the read replica. Creating read replicas allows you to offload read traffic from the primary (master) DB instance to one or more read replicas. Read replicas can serve read-only queries, distributing the load and improving overall query performance."
  },
  {
    "id": 634,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Create an FSx for ONTAP instance in the secondary Region. Use NetApp SnapMirror to replicate data from the primary Region to the secondary Region. FSx for ONTAP supports NetApp SnapMirror, which is a robust data replication technology. You can use SnapMirror to replicate data from the primary FSx for ONTAP instance in the primary Region to an FSx for ONTAP instance in the secondary Region."
  },
  {
    "id": 636,
    "topic": "Storage",
  ...
  },
  {
    ...
    "options": [
      ...
      "AWS Lambda",
      "Amazon DynamoDB",
      "Amazon EC2 Auto Scaling E. MySQL-compatible Amazon Aurora"
    ],
    "correctAnswer": 1,
    "explanation": "AWS Lambda AND Amazon DynamoDB. AWS Lambda is a serverless compute service that automatically scales with the number of incoming requests. It's suitable for unpredictable workloads, as it allows you to run code without provisioning or managing servers. Lambda functions can be triggered by API Gateway for handling HTTP requests. Amazon DynamoDB: DynamoDB is a fully managed NoSQL database service that can handle unpredictable and scalable workloads. It provides low-latency, high-throughput performance for simple key-value queries. DynamoDB automatically scales to accommodate varying request rates, and you pay for the throughput you provision."
  },
  {
    "id": 638,
    "topic": "Storage",
  ...
  },
  {
    ...
    "options": [
      ...
      "Create a new IAM policy with the kms:decrypt permission and attach the policy to the Lambda function. E. Create a new IAM role with the kms:decrypt permission and attach the execution role to the Lambda function."
    ],
    "correctAnswer": 1,
    "explanation": "Grant the decrypt permission for the Lambda IAM role in the KMS key's policy AND Create a new IAM role with the kms:decrypt permission and attach the execution role to the Lambda function."
  },
  {
    "id": 641,
    "topic": "General",
    ...
    "correctAnswer": 1,
    "explanation": "Enable Cost and Usage Reports in the management account. Deliver the reports to Amazon S3 Use Amazon Athena for analysis. Amazon Athena is a serverless query service that allows you to analyze data directly in Amazon S3 using SQL queries."
  },
  {
    "id": 642,
    "topic": "Compute",
    ...
    "correctAnswer": 0,
    "explanation": "Attach a Network Load Balancer to the Auto Scaling group. UDP is a connectionless protocol, and Network Load Balancers (NLB) support UDP, making them suitable for applications that use UDP for transmitting data."
  },
  {
    "id": 643,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Store the logs in Amazon S3. Use Amazon Athena tor analysis. Amazon Athena is a serverless query service that allows you to analyze data directly in Amazon S3 using standard SQL queries. It is cost-effective because you pay only for the queries you run, and there is no need to provision or manage infrastructure."
  },
  {
    "id": 644,
    "topic": "Storage",
    ...
    "options": [
      ...
      "Validate domain ownership by email address. Switch to DNS validation by adding the required DNS records to the DNS provider. E. Validate domain ownership for the domain by adding the required DNS records to the DNS provider."
    ],
    "correctAnswer": 0,
    "explanation": "Use the AWS Certificate Manager (ACM) console to request a public certificate for the apex top domain example com and a wildcard certificate for *.example.com AND Validate domain ownership for the domain by adding the required DNS records to the DNS provider. AWS Certificate Manager (ACM) is a service provided by Amazon Web Services (AWS) that simplifies the process of managing and provisioning SSL/TLS (Secure Sockets Layer/Transport Layer Security) certificates for your applications and websites. SSL/TLS certificates are essential for encrypting data in transit and securing communication between clients and servers. ACM requires domain ownership validation before issuing certificates. For wildcard certificates, DNS validation is necessary."
  },
  {
    "id": 645,
    "topic": "Security",
  ...
  },
  {
    ...
    "correctAnswer": 2,
    "explanation": "Use Amazon FSx for Lustre as a shared file system. Link the file system to an Amazon S3 bucket for postprocessing. FSx for Lustre is designed for high-performance computing workloads that require fast and scalable shared storage. It provides low-latency access to data and is well-suited for parallel processing across multiple instances."
  },
  {
    "id": 647,
    "topic": "High Availability",
    ...
    "correctAnswer": 0,
    "explanation": "Use AWS Global Accelerator with health checks. AWS Global Accelerator is a service that provides static IP addresses (Anycast) to route traffic over the AWS global network. It routes traffic over the optimal path to the AWS endpoint, improving availability and performance."
  },
  {
    "id": 648,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Use Amazon FSx for Lustre persistent file systems. Persistent file systems in FSx for Lustre are designed for longer-term storage needs. They provide a durable and highly available solution for your data. This is important for the weather forecasting company's requirement to handle large amounts of sustained throughput."
  },
  {
    "id": 649,
    "topic": "Storage",
    ...
    "correctAnswer": 2,
    "explanation": "Configure the General Purpose SSD (gp3) EBS volume storage type and provision 15,000 IOPS. Amazon EBS gp3 volumes are designed for general-purpose workloads and offer a balance of price and performance. They allow you to provision IOPS independently of storage capacity, similar to io1 volumes."
  },
  {
    "id": 650,
    "topic": "Database",
    ...
    "correctAnswer": 0,
    "explanation": "Migrate to Amazon RDS for Microsoft SOL Server. Use read replicas for reporting purposes. Amazon RDS supports read replicas, allowing you to offload reporting and analytical workloads to replicas without impacting the performance of the primary database. This is a cost-effective and efficient way to handle reporting without affecting transactional processing on the primary database."
  },
  {
    "id": 651,
    "topic": "Storage",
  ...
  },
  {
    ...
    "correctAnswer": 1,
    "explanation": "Configure a transient cluster that runs the primary node and core nodes on On-Demand Instances and the task nodes on Spot Instances. Transient clusters are cost-effective for short workloads. Spot Instances reduce costs for non-critical task nodes. Long-running clusters are unnecessary for a 6-hour workload."
  },
  {
    "id": 653,
    "topic": "Database",
    ...
    "correctAnswer": 1,
    "explanation": "Create an AWS Lambda function to tag the resources after the Lambda function looks up the appropriate cost center from the RDS database. Configure an Amazon EventBridge rule that reacts to AWS CloudTrail events to invoke the Lambda function. EventBridge + Lambda automates real-time tagging without manual intervention. SCPs cannot dynamically tag resources, and scheduled rules are not event-driven."
  },
  {
    "id": 654,
    "topic": "Compute",
    ...
    "correctAnswer": 3,
    "explanation": "Configure an Amazon CloudFront distribution with an Amazon S3 endpoint to an S3 bucket that is configured to host the static content. Configure an Application Load Balancer that targets an Amazon Elastic Container Service (Amazon ECS) service that runs AWS Fargate tasks for the PHP application. Configure the PHP application to use an Amazon ElastiCache for Redis cluster that runs in multiple Availability Zones. Fully managed services (ECS, ElastiCache) ensure high availability. CloudFront improves static content delivery. Elastic Beanstalk lacks decoupling, and Lambda is unsuitable for PHP sessions."
  },
  {
    "id": 655,
    "topic": "Compute",
    ...
    "options": [
      ...
      "Create a second target group. Add Elastic IP addresses to the EC2 instances. E. Create a web ACL in AWS WAF. Associate the web ACL with the endpoint"
    ],
    "correctAnswer": 2,
    "explanation": "Create a public Application Load Balancer. Specify the application target group AND Create a web ACL in AWS WAF. Associate the web ACL with the endpoint. ALB supports sticky sessions (unlike NLB/GWLB). WAF provides security. Elastic IPs are not scalable."
  },
  {
    "id": 656,
    "topic": "Storage",
    ...
    "correctAnswer": 3,
    "explanation": "Store images in Amazon S3 Standard-Infrequent Access (S3 Standard-IA). Use S3 Standard-IA to directly deliver images by using a static website. Standard-IA is cost-effective for rarely accessed images. Static websites simplify delivery. EBS/EFS are expensive and lack S3's durability."
  },
  {
    "id": 657,
    "topic": "Security",
    ...
    "correctAnswer": 1,
    "explanation": "Create a VPC customer managed prefix list that contains the list of CIDRs. Use AWS Resource Access Manager (AWS RAM) to share the prefix list across the organization. Use the prefix list in the security groups across the organization. Prefix lists centralize CIDR management. AWS RAM enables cross-account sharing. Firewall Manager is overkill for CIDR updates."
  },
  {
    "id": 658,
    "topic": "Migration",
    ...
    "options": [
      ...
      "Attach the EC2 instances to an Amazon FSx for OpenZFS file system. E. Attach the EC2 instances to an Amazon FSx for NetApp ONTAP file system."
    ],
    "correctAnswer": 0,
    "explanation": "Deploy compute optimized EC2 instances into a cluster placement group AND Attach the EC2 instances to an Amazon FSx for NetApp ONTAP file system. Cluster placement minimizes latency. FSx for ONTAP supports multi-protocol (NFS/SMB) access. Lustre lacks SMB support."
  },
  {
    "id": 659,
    "topic": "Compute",
    ...
    "correctAnswer": 2,
    "explanation": "AWS Snowball Edge Storage Optimized. Snowball Edge is ideal for large offline transfers (50 TB in 2 weeks) without VPN bottlenecks. DataSync is for online transfers; Direct Connect is too slow."
  },
  {
    "id": 660,
    "topic": "Compute",
    ...
    "correctAnswer": 3,
    "explanation": "Configure a scheduled scaling policy for the Auto Scaling group to launch new instances before peak hours. Proactively scales instances to handle predictable traffic spikes. Dynamic scaling reacts too slowly for known peaks."
  },
  {
    "id": 661,
    "topic": "Database",
    ...
    "correctAnswer": 1,
    "explanation": "Use Amazon RDS Proxy with a target group for the database. Change the applications to use the RDS Proxy endpoint. RDS Proxy manages scaling connections with minimal code changes. DynamoDB is incompatible with RDS."
  },
  {
    "id": 662,
    "topic": "Storage",
    ...
    "correctAnswer": 3,
    "explanation": "Delete all nonessential snapshots. Use Amazon Data Lifecycle Manager to create and manage the snapshots according to the company's snapshot policy requirements. Automates snapshot retention per policy, reducing costs. Manual resizing adds overhead."
  },
  {
    "id": 663,
    "topic": "Storage",
    ...
    "correctAnswer": 2,
    "explanation": "Create an S3 bucket policy that restricts bucket access to the ECS task execution role. Create a VPC endpoint for Amazon RDS for MySQL. Update the RDS for MySQL security group to allow access from only the subnets that the ECS cluster will generate tasks in. VPC endpoints keep traffic private. Security groups limit access to ECS subnets. KMS doesn't restrict network access."
  },
  {
    "id": 664,
    "topic": "Migration",
    ...
    "correctAnswer": 0,
    "explanation": "Configure an Elastic Beanstalk environment to use burstable performance instances in unlimited mode. Configure the environment to scale based on requests. Burstable instances handle CPU spikes cost-effectively. Request-based scaling matches demand. Compute-optimized instances are overprovisioned for intermittent spikes."
  },
  {
    "id": 665,
    "topic": "Security",
    ...
    "correctAnswer": 1,
    "explanation": "Use AWS CloudFormation to set up the infrastructure. Use AWS Config to track changes. CloudFormation automates infrastructure; Config tracks changes for auditing. Service Catalog is for governance, not change tracking."
  },
  {
    "id": 666,
    "topic": "Storage",
    ...
    "options": [
      ...
      "Use AWS DataSync to synchronize the database data across multiple EC2 instances. E. Create an Application Load Balancer to distribute traffic to an Auto Scaling group of EC2 instances that are distributed across two Availability Zones."
    ],
    "correctAnswer": 1,
    "explanation": "Migrate the database to an Amazon RDS for MySQL Multi-AZ DB instance AND Create an Application Load Balancer to distribute traffic to an Auto Scaling group of EC2 instances that are distributed across two Availability Zones. RDS Multi-AZ ensures DB high availability. ALB + Auto Scaling distributes traffic across AZs. DynamoDB requires code changes; DataSync doesn't solve HA."
  },
  {
    "id": 667,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Create gateway endpoints for Amazon S3. Use the gateway endpoints to securely access the data from the Region and the on-premises location. Gateway endpoints allow secure S3 access via Direct Connect/VPC without internet. Interface endpoints are for private-link services, not S3."
  },
  {
    "id": 668,
    "topic": "Security",
    ...
    "correctAnswer": 3,
    "explanation": "Create a tag policy in Organizations that has a list of allowed application names. Tag policies enforce standardized tagging across accounts. IAM policies cannot validate tag values."
  },
  {
    "id": 669,
    "topic": "Database",
    ...
    "correctAnswer": 2,
    "explanation": "Integrate AWS Secrets Manager with Amazon RDS for PostgreSQL to automate password rotation. Secrets Manager automates rotation every 30 days with zero operational effort. Manual rotation or Parameter Store lacks automation."
  },
  {
    "id": 670,
    "topic": "Database",
    ...
    "correctAnswer": 1,
    "explanation": "Choose provisioned mode. Update the read and write capacity units appropriately. Provisioned mode is cost-effective for predictable weekly workloads. On-demand is expensive for infrequent use."
  },
  {
    "id": 671,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Create an AWS Cost Anomaly Detection monitor in the AWS Billing and Cost Management console. Automatically detects and alerts on unusual spending. CloudWatch lacks built-in anomaly detection."
  },
  {
    "id": 672,
    "topic": "Storage",
    ...
    "correctAnswer": 1,
    "explanation": "Configure an AWS Glue crawler to crawl the data. Configure Amazon Athena to query the data. Glue catalogs data; Athena provides serverless SQL queries. EMR adds operational overhead."
  },
  {
    "id": 673,
    "topic": "General",
    ...
    "correctAnswer": 1,
    "explanation": "Create an Amazon S3 File Gateway to increase the company's storage space. Create an S3 Lifecycle policy to transition the data to S3 Glacier Deep Archive after 7 days. File Gateway extends on-prem storage; Glacier Deep Archive is cost-effective for archives. DataSync doesn't automate tiering."
  },
  {
    "id": 674,
    "topic": "Compute",
    ...
    "options": [
      ...
      "Create an Amazon ElastiCache cluster. Configure the application to cache query results in the ElastiCache cluster. E. Configure the Auto Scaling group subnets to ensure that the EC2 instances are provisioned in the same Availability Zone as the DB instance."
    ],
    "correctAnswer": 1,
    "explanation": "Create a read replica for the DB instance. Configure the application to send read traffic to the read replica AND Create an Amazon ElastiCache cluster. Configure the application to cache query results in the ElastiCache cluster. Read replicas offload read traffic. ElastiCache reduces DB load. Multi-AZ doesn't scale reads; auto scaling isn't for RDS."
  },
  {
    "id": 675,
    "topic": "Storage",
    ...
    "correctAnswer": 3,
    "explanation": "Lock the EBS snapshots to prevent deletion. Prevents accidental deletion without IAM changes. Recycle Bin requires tagging; IAM changes permissions."
  },
  {
    "id": 676,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Create a log group in Amazon CloudWatch Logs. Configure VPC Flow Logs to send the log data to the log group. Use Amazon Kinesis Data Firehose to stream the logs from the log group to OpenSearch Service. Flow Logs capture traffic; Firehose streams to OpenSearch. CloudTrail logs API calls, not network traffic."
  },
  {
    "id": 677,
    "topic": "Compute",
    ...
    "correctAnswer": 1,
    "explanation": "Create two managed node groups. Provision one node group with On-Demand Instances. Provision the second node group with Spot Instances. Balances cost (Spot) and reliability (On-Demand) for infrequent dev workloads. All-Spot risks interruptions; self-managed ASG adds overhead."
  },
  {
    "id": 678,
    "topic": "Storage",
    ...
    "correctAnswer": 1,
    "explanation": "Create a customer managed key by using AWS Key Management Service (AWS KMS). Use the new key to encrypt the S3 objects by using server-side encryption with AWS KMS keys (SSE-KMS). Grants full control over key rotation/access. SSE-S3 lacks key management. Client-side encryption is complex."
  },
  {
    "id": 679,
    "topic": "Storage",
    ...
    "options": [
      ...
      "Configure an S3 Lifecycle policy to protect the objects for 30 days. E. Configure an S3 Lifecycle policy to expire the objects after 30 days. F. Configure the backup solution to tag the objects with a 30-day retention period"
    ],
    "correctAnswer": 1,
    "explanation": "Create an S3 bucket that has object versioning enabled AND Configure a default retention period of 30 days for the objects AND Configure an S3 Lifecycle policy to expire the objects after 30 days. Versioning + retention policies automate compliance. Lifecycle rules expire objects. Object Lock prevents deletion; tagging doesn't enforce retention."
  },
  {
    "id": 680,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Create an AWS DataSync location for both the destination S3 bucket and the EFS file system. Create a task for the destination S3 bucket and the EFS file system. Set the transfer mode to transfer only data that has changed. Continuously syncs only modified files to S3/EFS. Lambda requires custom code; full syncs are inefficient."
  },
  {
    "id": 681,
    "topic": "Storage",
    ...
    "correctAnswer": 0,
    "explanation": "Create a customer managed key. Use the key to encrypt the EBS volumes. Allows control over key rotation. AWS-managed keys limit rotation flexibility."
  },
  {
    "id": 682,
    "topic": "Compute",
    "question": "A company needs a solution to enforce data encryption at rest on Amazon EC2 instances. The solution must automatically identify noncompliant resources and enforce compliance policies on findings. Which solution will meet these requirements with the LEAST administrative overhead?",
    "options": [
    ...
    "correctAnswer": 0,
    "explanation": "Use an IAM policy that allows users to create only encrypted Amazon Elastic Block Store (Amazon EBS) volumes. Use AWS Config and AWS Systems Manager to automate the detection and remediation of unencrypted EBS volumes. Config detects noncompliant volumes; Systems Manager automates remediation. Macie is for data classification, not encryption."
  },
  {
    "id": 683,
    "topic": "Database",
    ...
    "options": [
      ...
      "Migrate the web tier to an AWS Lambda function. E. Migrate the database to an Amazon DynamoDB table."
    ],
    "correctAnswer": 0,
    "explanation": "Migrate the web tier to Amazon EC2 instances in an Auto Scaling group behind an Application Load Balancer AND Migrate the database to an Amazon RDS Multi-AZ deployment. Auto Scaling improves web tier resiliency; RDS Multi-AZ ensures DB HA. Lambda requires code changes; DynamoDB is incompatible."
  },
  {
    "id": 684,
    "topic": "Migration",
    ...
    "correctAnswer": 1,
    "explanation": "Deploy the applications in AWS Local Zones by extending the company's VPC from eu-central-1 to the chosen Local Zone. Local Zones provide single-digit latency near eu-central-1 while complying with regulations. CloudFront is for caching, not app hosting."
  }
];
